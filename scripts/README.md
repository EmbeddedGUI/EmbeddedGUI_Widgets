...
- `python scripts/checks/check_web_artifacts.py`
  Validate checked-in `web/demos/` and `web/render-gallery/` artifacts against the published HelloCustomWidgets catalog, including bundled README synchronization.
