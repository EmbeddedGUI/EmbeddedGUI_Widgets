...
| --- | --- | --- | --- | --- | --- |
| 进行中 | `tab_strip` | `navigation` | `2026-04-10` | 交互收口与验证 | 复核 `tab select / same-target release / compact / read only / disabled / preview touch-key` 链路里的状态清理、静态 preview 与交互后渲染回归 |
