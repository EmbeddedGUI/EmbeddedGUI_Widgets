...
#include "../../HelloCustomWidgets/display/rectangle/egui_view_rectangle.h"
#include "../../HelloCustomWidgets/display/rectangle/egui_view_rectangle.c"

typedef struct rectangle_preview_snapshot rectangle_preview_snapshot_t;
struct rectangle_preview_snapshot
{
...
static egui_view_rectangle_t test_control;
static egui_view_rectangle_t preview_control;
...
static void setup_rectangle(void)
{
    egui_view_rectangle_init(EGUI_VIEW_OF(&test_control));
...
static void setup_preview_control(void)
{
    ...
    egui_view_rectangle_apply_compact_style(EGUI_VIEW_OF(&preview_control));
    egui_view_rectangle_override_static_preview_api(EGUI_VIEW_OF(&preview_control), &preview_api);
}
...
static void capture_preview_snapshot(rectangle_preview_snapshot_t *snapshot)
{
...
static void assert_preview_state_unchanged(const rectangle_preview_snapshot_t *snapshot)
{
...
static void test_rectangle_init_defaults(void)
{
    setup_rectangle();
    ...
    EGUI_TEST_ASSERT_EQUAL_INT(0, egui_view_rectangle_get_compact_mode(EGUI_VIEW_OF(&test_control)));
    EGUI_TEST_ASSERT_EQUAL_INT(0, egui_view_rectangle_get_read_only_mode(EGUI_VIEW_OF(&test_control)));
...
static void test_rectangle_setters_clamp_and_clear_pressed_state(void)
{
    setup_rectangle();
    egui_view_set_pressed(EGUI_VIEW_OF(&test_control), 1);
    egui_view_rectangle_set_stroke_width(EGUI_VIEW_OF(&test_control), -3);
    EGUI_TEST_ASSERT_FALSE(EGUI_VIEW_OF(&test_control)->is_pressed);
    EGUI_TEST_ASSERT_EQUAL_INT(0, egui_view_rectangle_get_stroke_width(EGUI_VIEW_OF(&test_control)));

    egui_view_rectangle_set_stroke_width(EGUI_VIEW_OF(&test_control), 99);
    EGUI_TEST_ASSERT_EQUAL_INT(6, egui_view_rectangle_get_stroke_width(EGUI_VIEW_OF(&test_control)));

    egui_view_rectangle_set_corner_radius(EGUI_VIEW_OF(&test_control), -1);
    EGUI_TEST_ASSERT_EQUAL_INT(0, egui_view_rectangle_get_corner_radius(EGUI_VIEW_OF(&test_control)));
    egui_view_rectangle_set_corner_radius(EGUI_VIEW_OF(&test_control), 99);
    EGUI_TEST_ASSERT_EQUAL_INT(18, egui_view_rectangle_get_corner_radius(EGUI_VIEW_OF(&test_control)));

    egui_view_rectangle_set_fill_enabled(EGUI_VIEW_OF(&test_control), 0);
    EGUI_TEST_ASSERT_EQUAL_INT(0, egui_view_rectangle_get_fill_enabled(EGUI_VIEW_OF(&test_control)));
    egui_view_rectangle_set_fill_enabled(EGUI_VIEW_OF(&test_control), 8);
    EGUI_TEST_ASSERT_EQUAL_INT(1, egui_view_rectangle_get_fill_enabled(EGUI_VIEW_OF(&test_control)));

    egui_view_rectangle_set_palette(EGUI_VIEW_OF(&test_control), EGUI_COLOR_HEX(0x010203), EGUI_COLOR_HEX(0x111213),
...
static void test_rectangle_styles(void)
{
    ...
    egui_view_rectangle_apply_compact_style(EGUI_VIEW_OF(&test_control));
    EGUI_TEST_ASSERT_EQUAL_INT(1, egui_view_rectangle_get_compact_mode(EGUI_VIEW_OF(&test_control)));
    EGUI_TEST_ASSERT_EQUAL_INT(0, egui_view_rectangle_get_read_only_mode(EGUI_VIEW_OF(&test_control)));
    EGUI_TEST_ASSERT_EQUAL_INT(1, egui_view_rectangle_get_stroke_width(EGUI_VIEW_OF(&test_control)));

    egui_view_rectangle_apply_read_only_style(EGUI_VIEW_OF(&test_control));
    EGUI_TEST_ASSERT_EQUAL_INT(1, egui_view_rectangle_get_compact_mode(EGUI_VIEW_OF(&test_control)));
    EGUI_TEST_ASSERT_EQUAL_INT(1, egui_view_rectangle_get_read_only_mode(EGUI_VIEW_OF(&test_control)));
}

static void test_rectangle_static_preview_consumes_input_and_keeps_state(void)
{
    rectangle_preview_snapshot_t initial_snapshot;
    egui_dim_t center_x;
    egui_dim_t center_y;
...
void test_rectangle_run(void)
{
    EGUI_TEST_SUITE_BEGIN(rectangle);
    EGUI_TEST_RUN(test_rectangle_init_defaults);
    EGUI_TEST_RUN(test_rectangle_setters_clamp_and_clear_pressed_state);
    EGUI_TEST_RUN(test_rectangle_styles);
    EGUI_TEST_RUN(test_rectangle_static_preview_consumes_input_and_keeps_state);
    EGUI_TEST_SUITE_END();
}
