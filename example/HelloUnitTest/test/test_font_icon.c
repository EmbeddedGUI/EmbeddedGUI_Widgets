...
static void test_font_icon_init_uses_default_glyph_font_and_palette(void)
{
    ...
    EGUI_TEST_ASSERT_EQUAL_INT(HCW_COLOR_PRIMARY.full, test_font_icon.color.full);
}
...
static void test_font_icon_style_helpers_and_setters_clear_pressed_state(void)
{
    ...
    EGUI_TEST_ASSERT_EQUAL_INT(HCW_COLOR_TEXT_SOFT.full, test_font_icon.color.full);

    egui_view_set_pressed(EGUI_VIEW_OF(&test_font_icon), 1);
    egui_view_font_icon_apply_accent_style(EGUI_VIEW_OF(&test_font_icon));
    EGUI_TEST_ASSERT_FALSE(EGUI_VIEW_OF(&test_font_icon)->is_pressed);
    EGUI_TEST_ASSERT_EQUAL_INT(HCW_COLOR_WARNING.full, test_font_icon.color.full);
    ...
    egui_view_set_pressed(EGUI_VIEW_OF(&test_font_icon), 1);
    egui_view_font_icon_set_palette(EGUI_VIEW_OF(&test_font_icon), HCW_COLOR_SUCCESS);
    EGUI_TEST_ASSERT_FALSE(EGUI_VIEW_OF(&test_font_icon)->is_pressed);
    EGUI_TEST_ASSERT_EQUAL_INT(HCW_COLOR_SUCCESS.full, test_font_icon.color.full);
