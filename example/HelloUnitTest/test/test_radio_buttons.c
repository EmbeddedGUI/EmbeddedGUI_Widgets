...
static void setup_widget(void)
{
    ...
    egui_view_set_size(EGUI_VIEW_OF(&test_widget), 196, 86);
...
static void setup_preview_widget(void)
{
    ...
    egui_view_set_size(EGUI_VIEW_OF(&preview_widget), 84, 52);
    egui_view_radio_buttons_set_items(EGUI_VIEW_OF(&preview_widget), g_items_preview, 2);
    egui_view_radio_buttons_set_current_index(EGUI_VIEW_OF(&preview_widget), 1);
...
{
    layout_view(EGUI_VIEW_OF(&test_widget), 10, 18, 196, 86);
}

static void layout_preview_widget(void)
{
    layout_view(EGUI_VIEW_OF(&preview_widget), 14, 22, 84, 52);
}
...
static void test_radio_buttons_static_preview_consumes_input_and_preserves_selection(void)
{
    egui_dim_t x;
    egui_dim_t y;
    ...
    EGUI_TEST_ASSERT_EQUAL_INT(1, egui_view_radio_buttons_get_current_index(EGUI_VIEW_OF(&preview_widget)));
    EGUI_TEST_ASSERT_EQUAL_INT(0, g_listener_count);
...
void test_radio_buttons_run(void)
{
    ...
    EGUI_TEST_RUN(test_radio_buttons_static_preview_consumes_input_and_preserves_selection);
    EGUI_TEST_SUITE_END();
}
