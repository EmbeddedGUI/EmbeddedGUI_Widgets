...
static void test_button_static_preview_consumes_input_and_clears_pressed_state(void)
{
    egui_dim_t inside_x;
    egui_dim_t inside_y;
...
void test_button_run(void)
{
    ...
    EGUI_TEST_RUN(test_button_static_preview_consumes_input_and_clears_pressed_state);
    EGUI_TEST_SUITE_END();
}
