...
static void setup_preview_box(void)
{
    ...
    hcw_combo_box_set_items(EGUI_VIEW_OF(&preview_box), g_mode_items, EGUI_ARRAY_SIZE(g_mode_items));
    hcw_combo_box_set_current_index(EGUI_VIEW_OF(&preview_box), 1);
...
static void test_combo_box_static_preview_consumes_input_and_clears_interaction_state(void)
{
    egui_view_combobox_t *local;
    egui_dim_t x;
    egui_dim_t y;
    ...
    EGUI_TEST_ASSERT_FALSE(egui_view_combobox_is_expanded(EGUI_VIEW_OF(&preview_box)));
    EGUI_TEST_ASSERT_FALSE(EGUI_VIEW_OF(&preview_box)->is_pressed);
    EGUI_TEST_ASSERT_EQUAL_INT(EGUI_VIEW_COMBOBOX_PRESSED_NONE, local->pressed_index);
    EGUI_TEST_ASSERT_EQUAL_INT(0, local->pressed_is_header);
    EGUI_TEST_ASSERT_EQUAL_INT(1, egui_view_combobox_get_current_index(EGUI_VIEW_OF(&preview_box)));
...
void test_combo_box_run(void)
{
    ...
    EGUI_TEST_RUN(test_combo_box_static_preview_consumes_input_and_clears_interaction_state);
    EGUI_TEST_SUITE_END();
}
