...
static void setup_preview_control(void)
{
    ...
    egui_view_ellipse_set_palette(EGUI_VIEW_OF(&preview_control), HCW_COLOR_SURFACE_PRESS, HCW_COLOR_PRIMARY,
...
static void test_ellipse_styles(void)
{
    ...
    egui_view_ellipse_set_palette(EGUI_VIEW_OF(&test_control), HCW_COLOR_SURFACE_PRESS, HCW_COLOR_PRIMARY,
                                  HCW_COLOR_PRIMARY_TINT);
    ...
    egui_view_ellipse_set_palette(EGUI_VIEW_OF(&test_control), HCW_COLOR_SURFACE_SUBTLE, HCW_COLOR_TEXT_SOFT,
