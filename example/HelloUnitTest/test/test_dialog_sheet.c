...
static void test_dialog_sheet_internal_helpers_cover_tone_glyph_metrics_and_regions(void)
{
    ...
    EGUI_TEST_ASSERT_TRUE(egui_view_dialog_sheet_is_space_char(' '));
    EGUI_TEST_ASSERT_FALSE(egui_view_dialog_sheet_is_space_char('R'));
    EGUI_TEST_ASSERT_TRUE(egui_view_dialog_sheet_is_break_after_char('-'));
    EGUI_TEST_ASSERT_TRUE(egui_view_dialog_sheet_is_break_after_char('/'));
    EGUI_TEST_ASSERT_FALSE(egui_view_dialog_sheet_is_break_after_char('x'));
    EGUI_TEST_ASSERT_EQUAL_INT(4, egui_view_dialog_sheet_find_elide_boundary("Open latest release notes.", 7));
    EGUI_TEST_ASSERT_EQUAL_INT(5, egui_view_dialog_sheet_find_elide_boundary("scan-first review", 5));
    ...
    egui_view_dialog_sheet_copy_elided(label, sizeof(label), "Open latest release notes.", 8);
    EGUI_TEST_ASSERT_TRUE(strcmp("Open...", label) == 0);
    egui_view_dialog_sheet_copy_elided(label, sizeof(label), "scan-first review", 10);
    ...
    egui_view_dialog_sheet_fit_text_to_width(NULL, "Open latest release notes.", label, sizeof(label), 28, 4);
    EGUI_TEST_ASSERT_TRUE(strcmp("Open...", label) == 0);
    egui_view_dialog_sheet_fit_text_to_width(NULL, "scan-first review", label, sizeof(label), 32, 4);
    EGUI_TEST_ASSERT_TRUE(strcmp("scan-...", label) == 0);
