...
static void test_card_action_read_only_and_disabled_guards_clear_pressed_state(void)
{
    egui_dim_t card_x;
    egui_dim_t card_y;
...
static void test_card_action_static_preview_consumes_input_and_preserves_state(void)
{
    egui_dim_t card_x;
    egui_dim_t card_y;
    ...
    preview_widget.current_part = EGUI_VIEW_CARD_ACTION_PART_CARD;
    seed_pressed_state(&preview_widget, EGUI_VIEW_CARD_ACTION_PART_CARD, 0);
...
void test_card_action_run(void)
{
    ...
    EGUI_TEST_RUN(test_card_action_read_only_and_disabled_guards_clear_pressed_state);
    EGUI_TEST_RUN(test_card_action_static_preview_consumes_input_and_preserves_state);
