...
static void test_tool_tip_internal_helpers(void)
{
    ...
    EGUI_TEST_ASSERT_TRUE(egui_view_tool_tip_is_space_char(' '));
    EGUI_TEST_ASSERT_FALSE(egui_view_tool_tip_is_space_char('S'));
    EGUI_TEST_ASSERT_TRUE(egui_view_tool_tip_is_break_after_char('-'));
    EGUI_TEST_ASSERT_TRUE(egui_view_tool_tip_is_break_after_char('/'));
    EGUI_TEST_ASSERT_FALSE(egui_view_tool_tip_is_break_after_char('x'));
    EGUI_TEST_ASSERT_EQUAL_INT(5, egui_view_tool_tip_find_elide_boundary("Quick save", 8));
    EGUI_TEST_ASSERT_EQUAL_INT(5, egui_view_tool_tip_find_elide_boundary("scan-first review", 5));
    egui_view_tool_tip_copy_elided(label, sizeof(label), "Documents", 6);
    EGUI_TEST_ASSERT_TRUE(strcmp("Doc...", label) == 0);
    egui_view_tool_tip_copy_elided(label, sizeof(label), "Quick save", 8);
    EGUI_TEST_ASSERT_TRUE(strcmp("Quick...", label) == 0);
    egui_view_tool_tip_copy_elided(label, sizeof(label), "scan-first review", 10);
    ...
    egui_view_tool_tip_fit_text_to_width(NULL, "Quick save", label, sizeof(label), 32, 4);
    EGUI_TEST_ASSERT_TRUE(strcmp("Quick...", label) == 0);
    egui_view_tool_tip_fit_text_to_width(NULL, "scan-first review", label, sizeof(label), 32, 4);
    EGUI_TEST_ASSERT_TRUE(strcmp("scan-...", label) == 0);
