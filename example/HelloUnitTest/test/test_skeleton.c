...
static void test_skeleton_attach_detach_and_helper_functions(void)
{
    ...
    EGUI_TEST_ASSERT_TRUE(egui_view_skeleton_is_space_char(' '));
    EGUI_TEST_ASSERT_FALSE(egui_view_skeleton_is_space_char('L'));
    EGUI_TEST_ASSERT_TRUE(egui_view_skeleton_is_break_after_char('-'));
    EGUI_TEST_ASSERT_TRUE(egui_view_skeleton_is_break_after_char('/'));
    EGUI_TEST_ASSERT_FALSE(egui_view_skeleton_is_break_after_char('x'));
    EGUI_TEST_ASSERT_EQUAL_INT(4, egui_view_skeleton_find_elide_boundary("Open latest release notes.", 7));
    EGUI_TEST_ASSERT_EQUAL_INT(5, egui_view_skeleton_find_elide_boundary("scan-first review", 5));
    ...
    egui_view_skeleton_copy_elided(label, sizeof(label), "Open latest release notes.", 8);
    EGUI_TEST_ASSERT_TRUE(strcmp("Open...", label) == 0);
    egui_view_skeleton_copy_elided(label, sizeof(label), "scan-first review", 10);
    ...
    egui_view_skeleton_fit_text_to_width(NULL, "Open latest release notes.", label, sizeof(label), 28, 4);
    EGUI_TEST_ASSERT_TRUE(strcmp("Open...", label) == 0);
    egui_view_skeleton_fit_text_to_width(NULL, "scan-first review", label, sizeof(label), 32, 4);
    EGUI_TEST_ASSERT_TRUE(strcmp("scan-...", label) == 0);
