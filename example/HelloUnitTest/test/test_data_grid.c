...
static void test_data_grid_static_preview_consumes_input_and_clears_pressed_state(void)
{
    egui_dim_t row_x;
    egui_dim_t row_y;
...
void test_data_grid_run(void)
{
    ...
    EGUI_TEST_RUN(test_data_grid_static_preview_consumes_input_and_clears_pressed_state);
    EGUI_TEST_SUITE_END();
}
