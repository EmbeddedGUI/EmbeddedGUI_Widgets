...
static void test_toggle_button_static_preview_consumes_input_and_clears_pressed_state(void)
{
    static egui_view_api_t preview_api;

    setup_button(1);
    hcw_toggle_button_override_static_preview_api(EGUI_VIEW_OF(&test_button), &preview_api);
    layout_button();
