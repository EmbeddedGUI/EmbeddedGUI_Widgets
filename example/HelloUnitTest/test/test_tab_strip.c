...
static void test_tab_strip_static_preview_consumes_input_and_keeps_state(void)
{
    egui_dim_t x;
    egui_dim_t y;
    ...
    EGUI_TEST_ASSERT_EQUAL_INT(1, preview_tab_strip.compact_mode);
...
void test_tab_strip_run(void)
{
    ...
    EGUI_TEST_RUN(test_tab_strip_static_preview_consumes_input_and_keeps_state);
    EGUI_TEST_SUITE_END();
}
