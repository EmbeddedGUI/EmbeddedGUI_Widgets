...
void test_init_ui(void)
{
    ...
    egui_view_spinner_init(EGUI_VIEW_OF(&primary_spinner), uicode_get_core());
    ...
    egui_view_spinner_init(EGUI_VIEW_OF(&compact_spinner), uicode_get_core());
    ...
    egui_view_spinner_init(EGUI_VIEW_OF(&muted_spinner), uicode_get_core());
