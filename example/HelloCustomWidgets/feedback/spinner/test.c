...
#define SPINNER_ROOT_HEIGHT          196
#define SPINNER_PRIMARY_PANEL_WIDTH  196
#define SPINNER_PRIMARY_PANEL_HEIGHT 92
#define SPINNER_PRIMARY_SIZE         44
#define SPINNER_PREVIEW_PANEL_WIDTH  104
#define SPINNER_PREVIEW_PANEL_HEIGHT 70
#define SPINNER_PREVIEW_SIZE         28
#define SPINNER_BOTTOM_ROW_WIDTH     216
#define SPINNER_BOTTOM_ROW_HEIGHT    70
...
static egui_view_linearlayout_t muted_panel;
static egui_view_label_t muted_heading_label;
static egui_view_spinner_t muted_spinner;
static egui_view_label_t muted_note_label;
...
static const spinner_snapshot_t primary_snapshots[] = {
        {"Syncing files", "Brand spinner stays low-noise but visible.", EGUI_COLOR_HEX(0x0F6CBD), 4, 104},
        {"Publishing docs", "Warm tone marks active background work.", EGUI_COLOR_HEX(0xB95A00), 4, 112},
        {"Refreshing cache", "Quiet tone keeps loading feedback lightweight.", EGUI_COLOR_HEX(0x0C7C73), 3, 88},
};
...
static void apply_preview_states(void)
{
    ...
    hcw_spinner_set_spinning(EGUI_VIEW_OF(&compact_spinner), 1);

    hcw_spinner_apply_muted_style(EGUI_VIEW_OF(&muted_spinner));
    hcw_spinner_set_spinning(EGUI_VIEW_OF(&muted_spinner), 1);
}
...
void test_init_ui(void)
{
    ...
    init_panel(&primary_panel, SPINNER_PRIMARY_PANEL_WIDTH, SPINNER_PRIMARY_PANEL_HEIGHT, EGUI_BG_OF(&bg_surface_panel), EGUI_ALIGN_HCENTER);
    ...
    init_text_label(&primary_heading_label, 176, 12, "Indeterminate loading", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x5E6D7C),
                    EGUI_ALIGN_CENTER);
    ...
    egui_view_group_add_child(EGUI_VIEW_OF(&primary_panel), EGUI_VIEW_OF(&primary_spinner));

    init_text_label(&primary_status_label, 176, 12, "Syncing files", (const egui_font_t *)&egui_res_font_montserrat_10_4, EGUI_COLOR_HEX(0x233241),
                    EGUI_ALIGN_CENTER);
    ...
    init_text_label(&primary_note_label, 176, 10, "Brand spinner stays low-noise but visible.", (const egui_font_t *)&egui_res_font_montserrat_8_4,
    ...
    init_panel(&compact_panel, SPINNER_PREVIEW_PANEL_WIDTH, SPINNER_PREVIEW_PANEL_HEIGHT, EGUI_BG_OF(&bg_muted_panel), EGUI_ALIGN_HCENTER);
    ...
    egui_view_set_margin(EGUI_VIEW_OF(&compact_spinner), 0, 0, 0, 6);
    egui_view_group_add_child(EGUI_VIEW_OF(&compact_panel), EGUI_VIEW_OF(&compact_spinner));
    ...
    init_panel(&muted_panel, SPINNER_PREVIEW_PANEL_WIDTH, SPINNER_PREVIEW_PANEL_HEIGHT, EGUI_BG_OF(&bg_surface_panel), EGUI_ALIGN_HCENTER);
    egui_view_set_margin(EGUI_VIEW_OF(&muted_panel), 8, 0, 0, 0);
    egui_view_group_add_child(EGUI_VIEW_OF(&bottom_row), EGUI_VIEW_OF(&muted_panel));

    init_text_label(&muted_heading_label, 84, 12, "Muted", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x233241),
                    EGUI_ALIGN_CENTER);
    egui_view_set_margin(EGUI_VIEW_OF(&muted_heading_label), 0, 0, 0, 6);
    egui_view_group_add_child(EGUI_VIEW_OF(&muted_panel), EGUI_VIEW_OF(&muted_heading_label));
    ...
    egui_view_set_margin(EGUI_VIEW_OF(&muted_spinner), 0, 0, 0, 6);
    egui_view_group_add_child(EGUI_VIEW_OF(&muted_panel), EGUI_VIEW_OF(&muted_spinner));

    init_text_label(&muted_note_label, 84, 12, "Quiet tone.", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x6B7A89),
                    EGUI_ALIGN_CENTER);
    egui_view_group_add_child(EGUI_VIEW_OF(&muted_panel), EGUI_VIEW_OF(&muted_note_label));
    ...
    egui_view_linearlayout_layout_childs(EGUI_VIEW_OF(&muted_panel));
