#ifndef _EGUI_VIEW_SNACKBAR_H_
#define _EGUI_VIEW_SNACKBAR_H_
...
#define EGUI_VIEW_SNACKBAR_MAX_SNAPSHOTS 4

typedef struct egui_view_snackbar_snapshot egui_view_snackbar_snapshot_t;
struct egui_view_snackbar_snapshot
{
    const char *title;
    const char *message;
    const char *action;
...
typedef void (*egui_view_snackbar_action_listener_t)(egui_view_t *self, uint8_t snapshot_index);
typedef void (*egui_view_snackbar_open_changed_listener_t)(egui_view_t *self, uint8_t opened);

typedef struct egui_view_snackbar egui_view_snackbar_t;
struct egui_view_snackbar
{
    egui_view_t base;
