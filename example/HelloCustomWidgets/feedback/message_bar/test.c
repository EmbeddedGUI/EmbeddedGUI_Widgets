...
#define MESSAGE_BAR_DEFAULT_SNAPSHOT  0
...
{
    apply_primary_snapshot(MESSAGE_BAR_DEFAULT_SNAPSHOT);
}
...
void test_init_ui(void)
{
    ...
    egui_view_message_bar_set_palette(EGUI_VIEW_OF(&bar_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
    ...
    egui_view_message_bar_set_snapshots(EGUI_VIEW_OF(&bar_compact), compact_snapshots, 1);
    ...
    egui_view_message_bar_set_palette(EGUI_VIEW_OF(&bar_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
                                      HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS,
                                      HCW_COLOR_WARNING, HCW_COLOR_DANGER);
    egui_view_message_bar_override_static_preview_api(EGUI_VIEW_OF(&bar_compact), &bar_compact_api);
    ...
    egui_view_message_bar_set_read_only_mode(EGUI_VIEW_OF(&bar_read_only), 1);
    egui_view_message_bar_set_palette(EGUI_VIEW_OF(&bar_read_only), HCW_COLOR_PANEL, HCW_COLOR_BORDER_STRONG, HCW_COLOR_TEXT_MUTED,
    ...
    egui_view_message_bar_override_static_preview_api(EGUI_VIEW_OF(&bar_read_only), &bar_read_only_api);
#if EGUI_CONFIG_FUNCTION_SUPPORT_FOCUS
