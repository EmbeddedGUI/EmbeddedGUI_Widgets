...
void test_init_ui(void)
{
    ...
    egui_view_info_bar_set_palette(EGUI_VIEW_OF(&info_bar_primary), EGUI_COLOR_HEX(0xFFFFFF), EGUI_COLOR_HEX(0xD5DDE5), EGUI_COLOR_HEX(0x1B2734),
    ...
    egui_view_info_bar_set_palette(EGUI_VIEW_OF(&info_bar_compact), EGUI_COLOR_HEX(0xFFFFFF), EGUI_COLOR_HEX(0xD5DDE5), EGUI_COLOR_HEX(0x1B2734),
                                   EGUI_COLOR_HEX(0x657687), EGUI_COLOR_HEX(0x0F6CBD), EGUI_COLOR_HEX(0x0F6CBD), EGUI_COLOR_HEX(0x107C41),
                                   EGUI_COLOR_HEX(0xA15C07), EGUI_COLOR_HEX(0xC42B1C));
    ...
    egui_view_info_bar_set_read_only_mode(EGUI_VIEW_OF(&info_bar_read_only), 1);
    egui_view_info_bar_set_palette(EGUI_VIEW_OF(&info_bar_read_only), EGUI_COLOR_HEX(0xFCFDFE), EGUI_COLOR_HEX(0xD0D8DF), EGUI_COLOR_HEX(0x8794A2),
