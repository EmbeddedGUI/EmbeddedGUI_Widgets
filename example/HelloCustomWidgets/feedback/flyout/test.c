...
void test_init_ui(void)
{
    ...
    egui_view_flyout_set_disabled_mode(EGUI_VIEW_OF(&flyout_disabled), 1);
    egui_view_flyout_set_palette(EGUI_VIEW_OF(&flyout_disabled), HCW_COLOR_PANEL, HCW_COLOR_BORDER_STRONG, HCW_COLOR_TEXT_SOFT,
                                 HCW_COLOR_TEXT_SOFT, HCW_COLOR_NEUTRAL, HCW_COLOR_NEUTRAL, HCW_COLOR_NEUTRAL,
                                 HCW_COLOR_NEUTRAL, HCW_COLOR_BORDER_STRONG, HCW_COLOR_PANEL, HCW_COLOR_BORDER_STRONG);
