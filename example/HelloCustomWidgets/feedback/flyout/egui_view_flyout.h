#ifndef _EGUI_VIEW_FLYOUT_H_
#define _EGUI_VIEW_FLYOUT_H_
...
#define EGUI_VIEW_FLYOUT_MAX_SNAPSHOTS 6

#define EGUI_VIEW_FLYOUT_PART_TARGET    0
#define EGUI_VIEW_FLYOUT_PART_PRIMARY   1
#define EGUI_VIEW_FLYOUT_PART_SECONDARY 2
#define EGUI_VIEW_FLYOUT_PART_NONE      0xFF

#define EGUI_VIEW_FLYOUT_TONE_ACCENT  0
#define EGUI_VIEW_FLYOUT_TONE_SUCCESS 1
#define EGUI_VIEW_FLYOUT_TONE_WARNING 2
#define EGUI_VIEW_FLYOUT_TONE_NEUTRAL 3

#define EGUI_VIEW_FLYOUT_PLACEMENT_BOTTOM 0
#define EGUI_VIEW_FLYOUT_PLACEMENT_TOP    1

typedef struct egui_view_flyout_snapshot egui_view_flyout_snapshot_t;
struct egui_view_flyout_snapshot
{
...
typedef void (*egui_view_on_flyout_action_listener_t)(egui_view_t *self, uint8_t snapshot_index, uint8_t part);

typedef struct egui_view_flyout egui_view_flyout_t;
struct egui_view_flyout
{
    egui_view_t base;
