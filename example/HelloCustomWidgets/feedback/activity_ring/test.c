...
#define ACTIVITY_RING_DEFAULT_SNAPSHOT  0
...
{
    apply_primary_snapshot(ACTIVITY_RING_DEFAULT_SNAPSHOT);
}
...
void test_init_ui(void)
{
    ...
    egui_view_label_init(EGUI_VIEW_OF(&activity_ring_status), uicode_get_core());
