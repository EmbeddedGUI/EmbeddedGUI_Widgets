...
void test_init_ui(void)
{
    ...
    egui_view_teaching_tip_set_palette(EGUI_VIEW_OF(&tip_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
                                       HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS, HCW_COLOR_WARNING,
                                       HCW_COLOR_NEUTRAL, HCW_COLOR_BORDER);
    ...
    egui_view_teaching_tip_set_palette(EGUI_VIEW_OF(&tip_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
                                       HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS, HCW_COLOR_WARNING,
                                       HCW_COLOR_NEUTRAL, HCW_COLOR_BORDER);
    ...
    egui_view_teaching_tip_set_read_only_mode(EGUI_VIEW_OF(&tip_read_only), 1);
    egui_view_teaching_tip_set_palette(EGUI_VIEW_OF(&tip_read_only), HCW_COLOR_PANEL, HCW_COLOR_BORDER_STRONG, HCW_COLOR_TEXT,
                                       HCW_COLOR_TEXT_SOFT, HCW_COLOR_TEXT_SOFT, HCW_COLOR_TEXT_SOFT, HCW_COLOR_TEXT_SOFT,
                                       HCW_COLOR_BORDER_STRONG, HCW_COLOR_BORDER_STRONG);
