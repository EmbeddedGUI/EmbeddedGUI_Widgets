...
static egui_view_toast_stack_t stack_read_only;
...
static const egui_view_toast_stack_snapshot_t read_only_snapshots[] = {
        {"Policy note", "Review only.", NULL, "Read only", "Daily sync", "Workspace", 0, 0},
};
...
{
    egui_view_toast_stack_set_current_snapshot(EGUI_VIEW_OF(&stack_compact), 0);
    egui_view_toast_stack_set_current_snapshot(EGUI_VIEW_OF(&stack_read_only), 0);
    egui_view_toast_stack_set_read_only_mode(EGUI_VIEW_OF(&stack_read_only), 1);
    if (ui_ready)
    {
        layout_page();
    }
...
void test_init_ui(void)
{
    ...
    egui_view_toast_stack_set_snapshots(EGUI_VIEW_OF(&stack_primary), primary_snapshots, PRIMARY_SNAPSHOT_COUNT);
    ...
    egui_view_toast_stack_set_palette(EGUI_VIEW_OF(&stack_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
    ...
    egui_view_toast_stack_set_snapshots(EGUI_VIEW_OF(&stack_compact), compact_snapshots, 1);
    egui_view_toast_stack_set_font(EGUI_VIEW_OF(&stack_compact), (const egui_font_t *)&egui_res_font_montserrat_10_4);
    ...
    egui_view_toast_stack_set_palette(EGUI_VIEW_OF(&stack_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
                                      HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS,
                                      HCW_COLOR_WARNING, HCW_COLOR_DANGER);
    egui_view_toast_stack_override_static_preview_api(EGUI_VIEW_OF(&stack_compact), &stack_compact_api);
    ...
    egui_view_toast_stack_init(EGUI_VIEW_OF(&stack_read_only));
    egui_view_set_size(EGUI_VIEW_OF(&stack_read_only), TOAST_STACK_PREVIEW_WIDTH, TOAST_STACK_PREVIEW_HEIGHT);
    egui_view_set_margin(EGUI_VIEW_OF(&stack_read_only), 8, 0, 0, 0);
    egui_view_toast_stack_set_snapshots(EGUI_VIEW_OF(&stack_read_only), read_only_snapshots, 1);
    egui_view_toast_stack_set_font(EGUI_VIEW_OF(&stack_read_only), (const egui_font_t *)&egui_res_font_montserrat_10_4);
    egui_view_toast_stack_set_meta_font(EGUI_VIEW_OF(&stack_read_only), (const egui_font_t *)&egui_res_font_montserrat_8_4);
    egui_view_toast_stack_set_compact_mode(EGUI_VIEW_OF(&stack_read_only), 1);
    egui_view_toast_stack_set_read_only_mode(EGUI_VIEW_OF(&stack_read_only), 1);
    egui_view_toast_stack_set_palette(EGUI_VIEW_OF(&stack_read_only), HCW_COLOR_PANEL, HCW_COLOR_BORDER_STRONG, HCW_COLOR_TEXT,
                                      HCW_COLOR_TEXT_MUTED, HCW_COLOR_TEXT_SOFT, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS,
                                      HCW_COLOR_WARNING_DARK, HCW_COLOR_DANGER_DARK);
    egui_view_toast_stack_override_static_preview_api(EGUI_VIEW_OF(&stack_read_only), &stack_read_only_api);
#if EGUI_CONFIG_FUNCTION_SUPPORT_FOCUS
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 8:
        ...
        EGUI_SIM_SET_WAIT(p_action, TOAST_STACK_RECORD_FINAL_WAIT);
        return true;
    default:
        return false;
    }
