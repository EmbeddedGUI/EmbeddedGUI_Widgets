...
{
    egui_view_selector_bar_set_current_index(EGUI_VIEW_OF(&compact_bar), index % 2);
}

static void apply_icon_only_index(uint8_t index)
{
    egui_view_selector_bar_set_current_index(EGUI_VIEW_OF(&icon_only_bar), index % 3);
}
