...
#define TITLE_BAR_RECORD_FINAL_WAIT 520
...
{
    egui_view_title_bar_set_current_snapshot(EGUI_VIEW_OF(&title_bar_compact), 0);
}
...
void test_init_ui(void)
{
    ...
    egui_view_title_bar_set_palette(EGUI_VIEW_OF(&title_bar_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
                                    HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SURFACE_SUBTLE, HCW_COLOR_BORDER,
                                    HCW_COLOR_BORDER);
    ...
    egui_view_title_bar_set_palette(EGUI_VIEW_OF(&title_bar_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT_STRONG,
                                    HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SURFACE_SUBTLE, HCW_COLOR_BORDER,
                                    HCW_COLOR_BORDER);
    ...
    egui_view_title_bar_set_read_only_mode(EGUI_VIEW_OF(&title_bar_read_only), 1);
    egui_view_title_bar_set_palette(EGUI_VIEW_OF(&title_bar_read_only), HCW_COLOR_PANEL, HCW_COLOR_BORDER, HCW_COLOR_TEXT_MUTED,
                                    HCW_COLOR_TEXT_SOFT, HCW_COLOR_TEXT_SOFT, HCW_COLOR_PANEL, HCW_COLOR_BORDER,
                                    HCW_COLOR_BORDER);
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 8:
        ...
        EGUI_SIM_SET_WAIT(p_action, TITLE_BAR_RECORD_FINAL_WAIT);
        return true;
    default:
        return false;
    }
