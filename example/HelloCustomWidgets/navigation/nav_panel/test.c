...
void test_init_ui(void)
{
    ...
    egui_view_nav_panel_set_palette(EGUI_VIEW_OF(&panel_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT_STRONG,
    ...
    egui_view_nav_panel_set_compact_mode(EGUI_VIEW_OF(&panel_compact), 1);
    egui_view_nav_panel_set_palette(EGUI_VIEW_OF(&panel_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT_STRONG,
                                    HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY);
    ...
    egui_view_nav_panel_set_compact_mode(EGUI_VIEW_OF(&panel_read_only), 1);
    egui_view_nav_panel_set_read_only_mode(EGUI_VIEW_OF(&panel_read_only), 1);
    egui_view_nav_panel_set_palette(EGUI_VIEW_OF(&panel_read_only), HCW_COLOR_PANEL, HCW_COLOR_BORDER, HCW_COLOR_TEXT_MUTED,
