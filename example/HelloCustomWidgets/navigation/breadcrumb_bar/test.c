...
#define BREADCRUMB_RECORD_FINAL_WAIT 520
...
void test_init_ui(void)
{
    ...
    egui_view_breadcrumb_bar_set_palette(EGUI_VIEW_OF(&bar_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT_STRONG,
    ...
    egui_view_breadcrumb_bar_set_snapshots(EGUI_VIEW_OF(&bar_compact), compact_snapshots, 1);
    egui_view_breadcrumb_bar_set_font(EGUI_VIEW_OF(&bar_compact), (const egui_font_t *)&egui_res_font_montserrat_8_4);
    egui_view_breadcrumb_bar_set_compact_mode(EGUI_VIEW_OF(&bar_compact), 1);
    egui_view_breadcrumb_bar_set_palette(EGUI_VIEW_OF(&bar_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT_STRONG,
                                         HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY);
    ...
    egui_view_breadcrumb_bar_set_compact_mode(EGUI_VIEW_OF(&bar_read_only), 1);
    egui_view_breadcrumb_bar_set_read_only_mode(EGUI_VIEW_OF(&bar_read_only), 1);
    egui_view_breadcrumb_bar_set_palette(EGUI_VIEW_OF(&bar_read_only), HCW_COLOR_PANEL, HCW_COLOR_BORDER, HCW_COLOR_TEXT_MUTED,
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 6:
        ...
        EGUI_SIM_SET_WAIT(p_action, BREADCRUMB_RECORD_FINAL_WAIT);
        return true;
    default:
        return false;
    }
