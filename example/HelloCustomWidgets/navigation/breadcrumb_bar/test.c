...
#define BREADCRUMB_RECORD_WAIT       90
#define BREADCRUMB_RECORD_FRAME_WAIT 170
...
static const char *read_only_items[] = {"Home", "Admin", "Reports", "Audit"};
static const egui_view_breadcrumb_bar_snapshot_t read_only_snapshots[] = {
        {"Read only", read_only_items, 4, 3},
};

static void apply_primary_snapshot(uint8_t index)
{
    egui_view_breadcrumb_bar_set_current_snapshot(EGUI_VIEW_OF(&bar_primary),
                                                  index % (sizeof(primary_snapshots) / sizeof(primary_snapshots[0])));
}

static void apply_compact_snapshot(uint8_t index)
{
    egui_view_breadcrumb_bar_set_current_snapshot(EGUI_VIEW_OF(&bar_compact),
                                                  index % (sizeof(compact_snapshots) / sizeof(compact_snapshots[0])));
}

static void apply_read_only_snapshot(void)
{
    egui_view_breadcrumb_bar_set_current_snapshot(EGUI_VIEW_OF(&bar_read_only), 0);
}
...
void test_init_ui(void)
{
    ...
    egui_view_breadcrumb_bar_set_palette(EGUI_VIEW_OF(&bar_primary), EGUI_COLOR_HEX(0xFFFFFF), EGUI_COLOR_HEX(0xD2DBE3), EGUI_COLOR_HEX(0x1A2734),
    ...
    egui_view_breadcrumb_bar_set_palette(EGUI_VIEW_OF(&bar_compact), EGUI_COLOR_HEX(0xFFFFFF), EGUI_COLOR_HEX(0xD2DBE3), EGUI_COLOR_HEX(0x1A2734),
                                         EGUI_COLOR_HEX(0x6B7A89), EGUI_COLOR_HEX(0x0F6CBD));
    ...
    egui_view_breadcrumb_bar_init(EGUI_VIEW_OF(&bar_read_only));
    egui_view_set_size(EGUI_VIEW_OF(&bar_read_only), BREADCRUMB_PREVIEW_WIDTH, BREADCRUMB_PREVIEW_HEIGHT);
    egui_view_set_margin(EGUI_VIEW_OF(&bar_read_only), 8, 0, 0, 0);
    egui_view_breadcrumb_bar_set_snapshots(EGUI_VIEW_OF(&bar_read_only), read_only_snapshots, 1);
    egui_view_breadcrumb_bar_set_font(EGUI_VIEW_OF(&bar_read_only), (const egui_font_t *)&egui_res_font_montserrat_8_4);
    egui_view_breadcrumb_bar_set_compact_mode(EGUI_VIEW_OF(&bar_read_only), 1);
    egui_view_breadcrumb_bar_set_locked_mode(EGUI_VIEW_OF(&bar_read_only), 1);
    egui_view_breadcrumb_bar_set_palette(EGUI_VIEW_OF(&bar_read_only), EGUI_COLOR_HEX(0xFBFCFD), EGUI_COLOR_HEX(0xD8DFE6), EGUI_COLOR_HEX(0x536474),
