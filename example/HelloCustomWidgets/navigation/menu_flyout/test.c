...
#define MENU_FLYOUT_RECORD_FINAL_WAIT 520
...
{
    egui_view_menu_flyout_set_current_snapshot(EGUI_VIEW_OF(&flyout_primary), (uint8_t)(index % PRIMARY_SNAPSHOT_COUNT));
    if (ui_ready)
    {
        layout_page();
    }
...
{
    egui_view_menu_flyout_set_current_snapshot(EGUI_VIEW_OF(&flyout_compact), 0);
    egui_view_menu_flyout_set_compact_mode(EGUI_VIEW_OF(&flyout_compact), 1);
}

static void apply_disabled_state(void)
{
    egui_view_menu_flyout_set_current_snapshot(EGUI_VIEW_OF(&flyout_disabled), 0);
...
{
    uint8_t next = (uint8_t)((egui_view_menu_flyout_get_current_snapshot(self) + 1) % PRIMARY_SNAPSHOT_COUNT);
...
void test_init_ui(void)
{
    ...
    egui_view_menu_flyout_set_snapshots(EGUI_VIEW_OF(&flyout_primary), primary_snapshots, PRIMARY_SNAPSHOT_COUNT);
    ...
    egui_view_menu_flyout_set_palette(EGUI_VIEW_OF(&flyout_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
                                      HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS, HCW_COLOR_WARNING,
                                      HCW_COLOR_DANGER, HCW_COLOR_BORDER);
    ...
    egui_view_menu_flyout_set_snapshots(EGUI_VIEW_OF(&flyout_compact), compact_snapshots, 1);
    ...
    egui_view_menu_flyout_set_compact_mode(EGUI_VIEW_OF(&flyout_compact), 1);
    egui_view_menu_flyout_set_palette(EGUI_VIEW_OF(&flyout_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
                                      HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS, HCW_COLOR_WARNING,
                                      HCW_COLOR_DANGER, HCW_COLOR_BORDER);
    ...
    egui_view_menu_flyout_set_compact_mode(EGUI_VIEW_OF(&flyout_disabled), 1);
    egui_view_menu_flyout_set_disabled_mode(EGUI_VIEW_OF(&flyout_disabled), 1);
    egui_view_menu_flyout_set_palette(EGUI_VIEW_OF(&flyout_disabled), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT,
                                      HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS, HCW_COLOR_WARNING,
                                      HCW_COLOR_DANGER, HCW_COLOR_BORDER);
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 8:
        ...
        EGUI_SIM_SET_WAIT(p_action, MENU_FLYOUT_RECORD_FINAL_WAIT);
        return true;
    default:
        return false;
    }
