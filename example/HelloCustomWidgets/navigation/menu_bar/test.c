...
#define MENU_BAR_PRIMARY_SNAPSHOT_COUNT ((uint8_t)(sizeof(primary_snapshots) / sizeof(primary_snapshots[0])))
...
{
    egui_view_menu_bar_set_current_snapshot(EGUI_VIEW_OF(&menu_bar_primary), (uint8_t)(index % MENU_BAR_PRIMARY_SNAPSHOT_COUNT));
    if (ui_ready)
    {
        layout_page();
    }
...
void test_init_ui(void)
{
    ...
    egui_view_menu_bar_set_snapshots(EGUI_VIEW_OF(&menu_bar_primary), primary_snapshots, MENU_BAR_PRIMARY_SNAPSHOT_COUNT);
    ...
    egui_view_menu_bar_set_palette(EGUI_VIEW_OF(&menu_bar_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT_STRONG,
    ...
    egui_view_menu_bar_set_compact_mode(EGUI_VIEW_OF(&menu_bar_compact), 1);
    egui_view_menu_bar_set_palette(EGUI_VIEW_OF(&menu_bar_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_TEXT_STRONG,
                                   HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS, HCW_COLOR_WARNING,
                                   HCW_COLOR_DANGER, HCW_COLOR_BORDER);
    ...
    egui_view_menu_bar_set_compact_mode(EGUI_VIEW_OF(&menu_bar_read_only), 1);
    egui_view_menu_bar_set_read_only_mode(EGUI_VIEW_OF(&menu_bar_read_only), 1);
    egui_view_menu_bar_set_palette(EGUI_VIEW_OF(&menu_bar_read_only), HCW_COLOR_PANEL, HCW_COLOR_BORDER, HCW_COLOR_TEXT_MUTED,
                                   HCW_COLOR_TEXT_SOFT, HCW_COLOR_TEXT_SOFT, HCW_COLOR_BORDER_STRONG, HCW_COLOR_WARNING_DARK,
                                   HCW_COLOR_DANGER_SOFT, HCW_COLOR_BORDER);
