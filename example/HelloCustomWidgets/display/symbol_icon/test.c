...
#define SYMBOL_ICON_ROOT_HEIGHT       196
#define SYMBOL_ICON_PANEL_WIDTH       196
#define SYMBOL_ICON_PANEL_HEIGHT      104
#define SYMBOL_ICON_PRIMARY_SIZE      64
#define SYMBOL_ICON_PREVIEW_WIDTH     104
#define SYMBOL_ICON_PREVIEW_HEIGHT    64
#define SYMBOL_ICON_PREVIEW_SIZE      32
#define SYMBOL_ICON_BOTTOM_ROW_WIDTH  216
#define SYMBOL_ICON_BOTTOM_ROW_HEIGHT 64
...
static const symbol_icon_snapshot_t primary_snapshots[] = {
        {
                ...
                "Primary symbol stays centered and readable on a quiet surface.",
        },
        {
                "Unread alerts",
                "Notifications",
                ...
                "Palette can shift emphasis without changing layout or glyph sizing.",
        },
        {
                "Workspace settings",
                "Settings",
                ...
                "A single symbol keeps the panel concise for compact reference states.",
        },
};
...
{
    const symbol_icon_snapshot_t *snapshot = &primary_snapshots[index % EGUI_ARRAY_SIZE(primary_snapshots)];
    ...
    egui_view_symbol_icon_set_palette(EGUI_VIEW_OF(&primary_icon), snapshot->color);
    egui_view_label_set_text(EGUI_VIEW_OF(&primary_name_label), snapshot->symbol_name);
...
void test_init_ui(void)
{
    ...
    init_panel(&primary_panel, SYMBOL_ICON_PANEL_WIDTH, SYMBOL_ICON_PANEL_HEIGHT, EGUI_BG_OF(&bg_surface_panel), EGUI_ALIGN_HCENTER);
    ...
    init_text_label(&primary_heading_label, 176, 12, "Home destination", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x51606F),
                    EGUI_ALIGN_CENTER);
    ...
    init_text_label(&primary_name_label, 176, 14, "Home", (const egui_font_t *)&egui_res_font_montserrat_10_4, EGUI_COLOR_HEX(0x0F6CBD), EGUI_ALIGN_CENTER);
    ...
    init_text_label(&primary_note_label, 176, 18, "Primary symbol stays centered and readable on a quiet surface.",
    ...
    init_panel(&subtle_panel, SYMBOL_ICON_PREVIEW_WIDTH, SYMBOL_ICON_PREVIEW_HEIGHT, EGUI_BG_OF(&bg_muted_panel), EGUI_ALIGN_HCENTER);
    ...
    egui_view_set_margin(EGUI_VIEW_OF(&subtle_heading_label), 0, 0, 0, 4);
    ...
    egui_view_set_margin(EGUI_VIEW_OF(&subtle_icon), 0, 0, 0, 6);
    ...
    init_text_label(&subtle_body_label, 84, 12, "Search", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x6B7A89), EGUI_ALIGN_CENTER);
    egui_view_group_add_child(EGUI_VIEW_OF(&subtle_panel), EGUI_VIEW_OF(&subtle_body_label));

    init_panel(&accent_panel, SYMBOL_ICON_PREVIEW_WIDTH, SYMBOL_ICON_PREVIEW_HEIGHT, EGUI_BG_OF(&bg_surface_panel), EGUI_ALIGN_HCENTER);
    ...
    egui_view_set_margin(EGUI_VIEW_OF(&accent_heading_label), 0, 0, 0, 4);
    ...
    egui_view_set_margin(EGUI_VIEW_OF(&accent_icon), 0, 0, 0, 6);
    ...
    init_text_label(&accent_body_label, 84, 12, "Info", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x6B7A89), EGUI_ALIGN_CENTER);
