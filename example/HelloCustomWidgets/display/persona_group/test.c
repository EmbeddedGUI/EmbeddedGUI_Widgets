...
{
    egui_view_set_enable(EGUI_VIEW_OF(&group_muted), 1);
...
void test_init_ui(void)
{
    ...
    egui_view_persona_group_set_palette(EGUI_VIEW_OF(&group_primary), HCW_COLOR_PANEL, HCW_COLOR_BORDER, HCW_COLOR_PANEL,
    ...
    egui_view_persona_group_set_palette(EGUI_VIEW_OF(&group_secondary), HCW_COLOR_PANEL, HCW_COLOR_BORDER, HCW_COLOR_PANEL,
                                        HCW_COLOR_TEXT, HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS,
                                        HCW_COLOR_WARNING, HCW_COLOR_NEUTRAL);
    ...
    egui_view_persona_group_set_palette(EGUI_VIEW_OF(&group_muted), HCW_COLOR_PANEL, HCW_COLOR_BORDER_STRONG,
                                        HCW_COLOR_PANEL, HCW_COLOR_TEXT, HCW_COLOR_TEXT_MUTED, HCW_COLOR_NEUTRAL,
                                        HCW_COLOR_SUCCESS, HCW_COLOR_WARNING_DARK, HCW_COLOR_BORDER_STRONG);
    egui_view_set_enable(EGUI_VIEW_OF(&group_muted), 1);
