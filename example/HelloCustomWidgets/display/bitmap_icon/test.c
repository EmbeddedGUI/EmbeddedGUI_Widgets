...
#define BITMAP_ICON_ROOT_HEIGHT       148
#define BITMAP_ICON_PRIMARY_SIZE      52
#define BITMAP_ICON_PREVIEW_SIZE      28
#define BITMAP_ICON_BOTTOM_ROW_WIDTH  64
#define BITMAP_ICON_BOTTOM_ROW_HEIGHT 28
#define BITMAP_ICON_RECORD_WAIT       90
#define BITMAP_ICON_RECORD_FRAME_WAIT 170
#define BITMAP_ICON_RECORD_FINAL_WAIT 280
#define BITMAP_ICON_DEFAULT_SNAPSHOT  0

#define PRIMARY_SNAPSHOT_COUNT ((uint8_t)EGUI_ARRAY_SIZE(primary_snapshots))

typedef struct bitmap_icon_snapshot bitmap_icon_snapshot_t;
struct bitmap_icon_snapshot
{
...
{
    const bitmap_icon_snapshot_t *snapshot = &primary_snapshots[index % PRIMARY_SNAPSHOT_COUNT];

    egui_view_bitmap_icon_set_image(EGUI_VIEW_OF(&primary_icon), snapshot->image);
    egui_view_bitmap_icon_apply_standard_style(EGUI_VIEW_OF(&primary_icon));
...
{
    apply_primary_snapshot(BITMAP_ICON_DEFAULT_SNAPSHOT);
}
...
void test_init_ui(void)
{
    ...
    egui_view_set_size(EGUI_VIEW_OF(&title_label), BITMAP_ICON_ROOT_WIDTH, 18);
    ...
    egui_view_set_size(EGUI_VIEW_OF(&primary_name_label), BITMAP_ICON_ROOT_WIDTH, 12);
    egui_view_label_set_text(EGUI_VIEW_OF(&primary_name_label), "Document");
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 6:
        ...
        EGUI_SIM_SET_WAIT(p_action, BITMAP_ICON_RECORD_FINAL_WAIT);
        return true;
    default:
        return false;
    }
