...
#define PATH_ICON_ROOT_HEIGHT       212
#define PATH_ICON_PANEL_WIDTH       196
#define PATH_ICON_PANEL_HEIGHT      116
#define PATH_ICON_PRIMARY_SIZE      56
#define PATH_ICON_PREVIEW_WIDTH     104
#define PATH_ICON_PREVIEW_HEIGHT    72
#define PATH_ICON_PREVIEW_SIZE      30
#define PATH_ICON_BOTTOM_ROW_WIDTH  216
#define PATH_ICON_BOTTOM_ROW_HEIGHT 72
...
static path_icon_snapshot_t primary_snapshots[] = {
        {
                ...
                "A compact vector path scales without bitmap assets.",
        },
        {
                "Warm reaction",
                NULL,
                ...
                "Quadratic curves stay lightweight for filled icon shapes.",
        },
        {
                "Outgoing action",
                NULL,
                ...
                "Path data swaps without changing the surrounding layout.",
        },
};
...
{
    const path_icon_snapshot_t *snapshot = &primary_snapshots[index % EGUI_ARRAY_SIZE(primary_snapshots)];
    ...
    egui_view_path_icon_set_palette(EGUI_VIEW_OF(&primary_icon), snapshot->color);
...
void test_init_ui(void)
{
    ...
    init_panel(&primary_panel, PATH_ICON_PANEL_WIDTH, PATH_ICON_PANEL_HEIGHT, EGUI_BG_OF(&bg_surface_panel), EGUI_ALIGN_HCENTER);
    ...
    init_text_label(&primary_heading_label, 176, 12, "Saved collection", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x51606F),
                    EGUI_ALIGN_CENTER);
    ...
    init_text_label(&primary_name_label, 176, 14, "Bookmark", (const egui_font_t *)&egui_res_font_montserrat_10_4, EGUI_COLOR_HEX(0x0F6CBD),
                    EGUI_ALIGN_CENTER);
    egui_view_set_margin(EGUI_VIEW_OF(&primary_name_label), 0, 0, 0, 3);
    egui_view_group_add_child(EGUI_VIEW_OF(&primary_panel), EGUI_VIEW_OF(&primary_name_label));

    init_text_label(&primary_note_label, 176, 18, "A compact vector path scales without bitmap assets.",
    ...
    init_panel(&subtle_panel, PATH_ICON_PREVIEW_WIDTH, PATH_ICON_PREVIEW_HEIGHT, EGUI_BG_OF(&bg_muted_panel), EGUI_ALIGN_HCENTER);
    ...
    init_text_label(&subtle_body_label, 84, 12, "Heart", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x6B7A89), EGUI_ALIGN_CENTER);
    egui_view_group_add_child(EGUI_VIEW_OF(&subtle_panel), EGUI_VIEW_OF(&subtle_body_label));

    init_panel(&accent_panel, PATH_ICON_PREVIEW_WIDTH, PATH_ICON_PREVIEW_HEIGHT, EGUI_BG_OF(&bg_surface_panel), EGUI_ALIGN_HCENTER);
    ...
    init_text_label(&accent_body_label, 84, 12, "Send", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x6B7A89), EGUI_ALIGN_CENTER);
