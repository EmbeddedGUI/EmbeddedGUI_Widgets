...
static egui_view_path_t compact_preview;
static egui_view_path_t read_only_preview;
...
static const path_snapshot_t primary_snapshots[] = {
        ...
        {"Compact / line data", EGUI_COLOR_HEX(0x0C7C73), 2},
        {"Read only / silhouette", EGUI_COLOR_HEX(0x65717E), 3},
};
...
static void apply_path_style(egui_view_t *view, uint8_t style)
{
    ...
    case 1:
        ...
        break;
    case 2:
        egui_view_path_apply_compact_style(view);
        break;
    case 3:
        egui_view_path_apply_read_only_style(view);
        break;
    default:
...
{
    egui_view_path_apply_compact_style(EGUI_VIEW_OF(&compact_preview));
    egui_view_path_apply_read_only_style(EGUI_VIEW_OF(&read_only_preview));
...
void test_init_ui(void)
{
    ...
    egui_view_path_init(EGUI_VIEW_OF(&compact_preview));
    egui_view_set_size(EGUI_VIEW_OF(&compact_preview), PATH_PREVIEW_WIDTH, PATH_PREVIEW_HEIGHT);
    egui_view_path_override_static_preview_api(EGUI_VIEW_OF(&compact_preview), &compact_preview_api);
    ...
    egui_view_path_init(EGUI_VIEW_OF(&read_only_preview));
    egui_view_set_size(EGUI_VIEW_OF(&read_only_preview), PATH_PREVIEW_WIDTH, PATH_PREVIEW_HEIGHT);
    egui_view_set_margin(EGUI_VIEW_OF(&read_only_preview), 16, 0, 0, 0);
    egui_view_path_override_static_preview_api(EGUI_VIEW_OF(&read_only_preview), &read_only_preview_api);
#if EGUI_CONFIG_FUNCTION_SUPPORT_FOCUS
