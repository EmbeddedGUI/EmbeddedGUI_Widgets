...
{
    egui_view_rectangle_set_palette(self, HCW_COLOR_SURFACE, HCW_COLOR_PRIMARY, HCW_COLOR_PRIMARY_TINT);
...
{
    egui_view_rectangle_set_palette(self, HCW_COLOR_SURFACE_SUBTLE, HCW_COLOR_PRIMARY, HCW_COLOR_PRIMARY_TINT);
    egui_view_rectangle_set_stroke_width(self, 2);
