...
#define PERSON_PICTURE_ROOT_HEIGHT       170
#define PERSON_PICTURE_PRIMARY_SIZE      72
#define PERSON_PICTURE_PREVIEW_SIZE      38
#define PERSON_PICTURE_BOTTOM_ROW_WIDTH  84
#define PERSON_PICTURE_BOTTOM_ROW_HEIGHT 38
#define PERSON_PICTURE_RECORD_WAIT       90
#define PERSON_PICTURE_RECORD_FRAME_WAIT 170
#define PERSON_PICTURE_RECORD_FINAL_WAIT 280
#define PERSON_PICTURE_DEFAULT_SNAPSHOT  0

#define PRIMARY_SNAPSHOT_COUNT ((uint8_t)EGUI_ARRAY_SIZE(primary_snapshots))

typedef struct person_picture_snapshot person_picture_snapshot_t;
struct person_picture_snapshot
{
...
{
    const person_picture_snapshot_t *snapshot = &primary_snapshots[index % PRIMARY_SNAPSHOT_COUNT];
    ...
    egui_view_label_set_font_color(EGUI_VIEW_OF(&primary_status_label), snapshot->status_color, EGUI_ALPHA_100);
    if (ui_ready)
    {
        layout_page();
    }
...
{
    apply_primary_snapshot(PERSON_PICTURE_DEFAULT_SNAPSHOT);
}
