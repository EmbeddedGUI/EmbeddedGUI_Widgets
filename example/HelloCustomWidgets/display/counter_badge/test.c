...
static egui_view_counter_badge_t small_badge;
static egui_view_counter_badge_t muted_badge;
static egui_view_api_t small_api;
...
void test_init_ui(void)
{
    ...
    egui_view_counter_badge_init(EGUI_VIEW_OF(&small_badge));
    egui_view_set_size(EGUI_VIEW_OF(&small_badge), COUNTER_BADGE_PREVIEW_LEFT_W, COUNTER_BADGE_PREVIEW_HEIGHT);
    egui_view_counter_badge_override_static_preview_api(EGUI_VIEW_OF(&small_badge), &small_api);
#if EGUI_CONFIG_FUNCTION_SUPPORT_FOCUS
    egui_view_set_focusable(EGUI_VIEW_OF(&small_badge), 0);
#endif
    egui_view_group_add_child(EGUI_VIEW_OF(&bottom_row), EGUI_VIEW_OF(&small_badge));

    egui_view_counter_badge_init(EGUI_VIEW_OF(&muted_badge));
    egui_view_set_size(EGUI_VIEW_OF(&muted_badge), COUNTER_BADGE_PREVIEW_RIGHT_W, COUNTER_BADGE_PREVIEW_HEIGHT);
    egui_view_set_margin(EGUI_VIEW_OF(&muted_badge), 8, 0, 0, 0);
    egui_view_counter_badge_override_static_preview_api(EGUI_VIEW_OF(&muted_badge), &muted_api);
#if EGUI_CONFIG_FUNCTION_SUPPORT_FOCUS
