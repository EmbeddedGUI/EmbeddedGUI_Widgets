...
void test_init_ui(void)
{
    ...
    egui_view_settings_panel_set_palette(EGUI_VIEW_OF(&panel_primary), HCW_COLOR_SURFACE, HCW_COLOR_SURFACE_PRESS, HCW_COLOR_BORDER,
    ...
    egui_view_settings_panel_set_palette(EGUI_VIEW_OF(&panel_compact), HCW_COLOR_SURFACE, HCW_COLOR_SURFACE_PRESS, HCW_COLOR_BORDER,
                                         HCW_COLOR_TEXT, HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS,
                                         HCW_COLOR_WARNING, HCW_COLOR_NEUTRAL);
    ...
    egui_view_settings_panel_set_palette(EGUI_VIEW_OF(&panel_read_only), HCW_COLOR_PANEL, HCW_COLOR_PANEL, HCW_COLOR_BORDER,
