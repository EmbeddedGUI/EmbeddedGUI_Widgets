#ifndef _EGUI_VIEW_SETTINGS_EXPANDER_H_
#define _EGUI_VIEW_SETTINGS_EXPANDER_H_
...
#define EGUI_VIEW_SETTINGS_EXPANDER_MAX_SNAPSHOTS 6
#define EGUI_VIEW_SETTINGS_EXPANDER_MAX_ROWS      4

#define EGUI_VIEW_SETTINGS_EXPANDER_PART_HEADER   0
#define EGUI_VIEW_SETTINGS_EXPANDER_PART_ROW_BASE 1
#define EGUI_VIEW_SETTINGS_EXPANDER_PART_NONE     0xFF

#define EGUI_VIEW_SETTINGS_EXPANDER_TRAILING_VALUE      0
#define EGUI_VIEW_SETTINGS_EXPANDER_TRAILING_SWITCH_ON  1
#define EGUI_VIEW_SETTINGS_EXPANDER_TRAILING_SWITCH_OFF 2
#define EGUI_VIEW_SETTINGS_EXPANDER_TRAILING_CHEVRON    3

#define EGUI_VIEW_SETTINGS_EXPANDER_TONE_ACCENT  0
#define EGUI_VIEW_SETTINGS_EXPANDER_TONE_SUCCESS 1
#define EGUI_VIEW_SETTINGS_EXPANDER_TONE_WARNING 2
#define EGUI_VIEW_SETTINGS_EXPANDER_TONE_NEUTRAL 3

typedef struct egui_view_settings_expander_row egui_view_settings_expander_row_t;
struct egui_view_settings_expander_row
{
...
typedef struct egui_view_settings_expander_snapshot egui_view_settings_expander_snapshot_t;
struct egui_view_settings_expander_snapshot
{
    const char *eyebrow;
    const char *icon_text;
    const char *title;
    ...
    const char *value;
    const char *footer;
    const egui_view_settings_expander_row_t *rows;
    uint8_t row_count;
    uint8_t tone;
    uint8_t expanded;
    uint8_t focus_part;
...
typedef void (*egui_view_on_settings_expander_action_listener_t)(egui_view_t *self, uint8_t snapshot_index, uint8_t part);

typedef struct egui_view_settings_expander egui_view_settings_expander_t;
struct egui_view_settings_expander
{
    egui_view_t base;
    const egui_view_settings_expander_snapshot_t *snapshots;
    const egui_font_t *font;
    const egui_font_t *meta_font;
    egui_view_on_settings_expander_action_listener_t on_action;
...
#endif /* _EGUI_VIEW_SETTINGS_EXPANDER_H_ */
