...
#define SETTINGS_EXPANDER_RECORD_FINAL_WAIT 280
...
static const egui_view_settings_expander_snapshot_t compact_snapshot = {
...
{
    egui_view_settings_expander_set_current_snapshot(EGUI_VIEW_OF(&expander_compact), 0);
    egui_view_settings_expander_set_current_snapshot(EGUI_VIEW_OF(&expander_read_only), 0);
    if (ui_ready)
    {
        layout_page();
    }
...
void test_init_ui(void)
{
    ...
    egui_view_settings_expander_set_palette(EGUI_VIEW_OF(&expander_primary), HCW_COLOR_SURFACE, HCW_COLOR_SURFACE_PRESS, HCW_COLOR_BORDER,
    ...
    egui_view_settings_expander_set_snapshots(EGUI_VIEW_OF(&expander_compact), &compact_snapshot, 1);
    ...
    egui_view_settings_expander_set_palette(EGUI_VIEW_OF(&expander_read_only), HCW_COLOR_PANEL, HCW_COLOR_PANEL,
                                            HCW_COLOR_BORDER_STRONG, HCW_COLOR_TEXT, HCW_COLOR_TEXT_SOFT, HCW_COLOR_TEXT_SOFT,
                                            HCW_COLOR_TEXT_SOFT, HCW_COLOR_TEXT_SOFT, HCW_COLOR_BORDER_STRONG);
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 7:
        ...
        EGUI_SIM_SET_WAIT(p_action, SETTINGS_EXPANDER_RECORD_FINAL_WAIT);
        return true;
    case 8:
        if (first_call)
        {
