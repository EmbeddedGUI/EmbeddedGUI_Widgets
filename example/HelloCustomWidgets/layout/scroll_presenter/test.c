...
static const egui_view_scroll_presenter_snapshot_t compact_snapshots[] = {
        {"UI", "Compact pan", "", "", "Compact", compact_items, 3, 176, 148, 108, 82, 18, 12},
        {"OPS", "Compact edge", "", "", "Edge", timeline_items, 3, 188, 152, 108, 82, 24, 18},
};
...
{
    egui_view_scroll_presenter_set_current_snapshot(EGUI_VIEW_OF(&scroll_presenter_compact), index % COMPACT_SNAPSHOT_COUNT);
}

static void dismiss_primary_presenter_focus(void)
{
#if EGUI_CONFIG_FUNCTION_SUPPORT_FOCUS
    egui_view_clear_focus(EGUI_VIEW_OF(&scroll_presenter_primary));
#endif
}
...
static int dismiss_primary_focus_on_preview_touch(egui_view_t *self, egui_motion_event_t *event)
{
    ...
    {
        dismiss_primary_presenter_focus();
    }
    return 1;
}
...
static void apply_primary_key(uint8_t key_code)
{
    ...
    egui_view_dispatch_key_event(EGUI_VIEW_OF(&scroll_presenter_primary), &event);
...
void test_init_ui(void)
{
    ...
    egui_view_scroll_presenter_set_snapshots(EGUI_VIEW_OF(&scroll_presenter_compact), compact_snapshots, COMPACT_SNAPSHOT_COUNT);
    ...
    scroll_presenter_compact_api.on_touch = dismiss_primary_focus_on_preview_touch;
#endif
#if EGUI_CONFIG_FUNCTION_SUPPORT_FOCUS
...
#if EGUI_CONFIG_FUNCTION_SUPPORT_TOUCH
    scroll_presenter_read_only_api.on_touch = dismiss_primary_focus_on_preview_touch;
#endif
#if EGUI_CONFIG_FUNCTION_SUPPORT_FOCUS
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 7:
        ...
        return true;
    case 8:
        set_click_view_center(p_action, EGUI_VIEW_OF(&scroll_presenter_compact), SCROLL_PRESENTER_RECORD_WAIT);
        return true;
    case 9:
        if (first_call)
        {
