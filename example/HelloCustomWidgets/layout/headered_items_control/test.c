...
#define HEADERED_ITEMS_CONTROL_PREVIEW_HEIGHT    54
...
static void apply_preview_states(void)
{
    ...
    egui_view_label_set_font_color(EGUI_VIEW_OF(&wrap_header), EGUI_COLOR_HEX(0x0F7B45), EGUI_ALPHA_100);
...
void test_init_ui(void)
{
    ...
    init_text_label(&primary_header, 126, 16, primary_snapshots[0].header, (const egui_font_t *)&egui_res_font_montserrat_8_4,
                    EGUI_COLOR_HEX(0x0F6CBD), EGUI_ALIGN_LEFT | EGUI_ALIGN_VCENTER);
    ...
    init_text_label(&wrap_header, 58, 12, "Wrap", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x0F7B45),
    ...
    for (i = 0; i < 3; i++)
    {
        init_text_label(&wrap_items[i], 36, 12, "One", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x0F7B45),
                        EGUI_ALIGN_CENTER);
    ...
    init_text_label(&read_only_header, 64, 12, "Read only", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x65717E),
                    EGUI_ALIGN_LEFT | EGUI_ALIGN_VCENTER);
    egui_view_headered_items_control_set_header(EGUI_VIEW_OF(&read_only_preview), EGUI_VIEW_OF(&read_only_header));
    for (i = 0; i < 3; i++)
    {
        init_text_label(&read_only_items[i], 58, 11, "Static", (const egui_font_t *)&egui_res_font_montserrat_8_4, EGUI_COLOR_HEX(0x65717E),
                        EGUI_ALIGN_CENTER);
