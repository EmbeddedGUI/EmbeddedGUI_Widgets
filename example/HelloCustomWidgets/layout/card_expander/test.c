...
void test_init_ui(void)
{
    ...
    egui_view_card_expander_set_palette(EGUI_VIEW_OF(&card_primary), HCW_COLOR_SURFACE, HCW_COLOR_SURFACE_PRESS, HCW_COLOR_BORDER,
    ...
    egui_view_card_expander_set_palette(EGUI_VIEW_OF(&card_read_only), HCW_COLOR_PANEL, HCW_COLOR_PANEL,
