...
void test_init_ui(void)
{
    ...
    egui_view_items_repeater_set_palette(EGUI_VIEW_OF(&wrap_primary), HCW_COLOR_PANEL, HCW_COLOR_PANEL, HCW_COLOR_BORDER,
    ...
    egui_view_items_repeater_set_palette(EGUI_VIEW_OF(&wrap_compact), HCW_COLOR_PANEL, HCW_COLOR_PANEL, HCW_COLOR_BORDER,
                                     HCW_COLOR_TEXT, HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS,
    ...
    egui_view_items_repeater_set_palette(EGUI_VIEW_OF(&wrap_read_only), HCW_COLOR_PANEL, HCW_COLOR_PANEL, HCW_COLOR_BORDER,
