...
#define DATA_LIST_PANEL_RECORD_FINAL_WAIT 280
#define DATA_LIST_PANEL_DEFAULT_SNAPSHOT  0

typedef struct
{
    uint8_t snapshot_index;
    uint8_t item_index;
} data_list_panel_state_t;
...
static const data_list_panel_state_t primary_states[] = {
        {0, 0},
        {1, 1},
        {2, 0},
};
...
static void apply_snapshot_state(egui_view_t *view, const egui_view_data_list_panel_snapshot_t *snapshots, uint8_t snapshot_count, uint8_t snapshot_index, uint8_t item_index)
{
    const egui_view_data_list_panel_snapshot_t *snapshot = &snapshots[snapshot_index % snapshot_count];
    uint8_t resolved_item_index = clamp_item_index(snapshot, item_index);

    egui_view_data_list_panel_set_current_snapshot(view, snapshot_index % snapshot_count);
    egui_view_data_list_panel_set_current_index(view, resolved_item_index);
}
...
{
    apply_primary_state(DATA_LIST_PANEL_DEFAULT_SNAPSHOT);
}
...
void test_init_ui(void)
{
    ...
    egui_view_data_list_panel_set_palette(EGUI_VIEW_OF(&panel_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_SURFACE_PRESS,
    ...
    egui_view_data_list_panel_set_palette(EGUI_VIEW_OF(&panel_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_SURFACE_PRESS,
                                          HCW_COLOR_TEXT, HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS,
                                          HCW_COLOR_WARNING, HCW_COLOR_NEUTRAL);
    ...
    egui_view_data_list_panel_set_palette(EGUI_VIEW_OF(&panel_read_only), HCW_COLOR_SURFACE, HCW_COLOR_BORDER, HCW_COLOR_SURFACE_PRESS,
                                          HCW_COLOR_TEXT, HCW_COLOR_TEXT_MUTED, HCW_COLOR_PRIMARY, HCW_COLOR_SUCCESS,
                                          HCW_COLOR_WARNING, HCW_COLOR_NEUTRAL);
