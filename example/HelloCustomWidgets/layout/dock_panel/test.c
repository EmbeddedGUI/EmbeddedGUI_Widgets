...
EGUI_BACKGROUND_COLOR_PARAM_INIT_ROUND_RECTANGLE(bg_dock_standard_param, HCW_COLOR_PANEL, EGUI_ALPHA_100, 10);
...
EGUI_BACKGROUND_COLOR_PARAM_INIT_ROUND_RECTANGLE(bg_dock_compact_param, HCW_COLOR_SURFACE_SUBTLE, EGUI_ALPHA_100, 10);
...
void test_init_ui(void)
{
    ...
    init_text_label(&title_label, DOCK_PANEL_ROOT_WIDTH, 18, title_text, (const egui_font_t *)&egui_res_font_montserrat_12_4, HCW_COLOR_TEXT,
                    EGUI_ALIGN_CENTER);
    ...
    init_text_label(&rail_heading_label, 84, 12, "Rail", (const egui_font_t *)&egui_res_font_montserrat_8_4, HCW_COLOR_TEXT, EGUI_ALIGN_CENTER);
    ...
    init_text_label(&rail_note_label, 84, 10, "Static preview.", (const egui_font_t *)&egui_res_font_montserrat_8_4, HCW_COLOR_TEXT_MUTED,
                    EGUI_ALIGN_CENTER);
    ...
    init_text_label(&footer_heading_label, 84, 12, "Footer", (const egui_font_t *)&egui_res_font_montserrat_8_4, HCW_COLOR_TEXT,
                    EGUI_ALIGN_CENTER);
    ...
    init_text_label(&footer_note_label, 84, 10, "Quiet shell.", (const egui_font_t *)&egui_res_font_montserrat_8_4, HCW_COLOR_TEXT_MUTED,
                    EGUI_ALIGN_CENTER);
