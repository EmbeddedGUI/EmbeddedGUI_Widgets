                                    ...
                                    const char *body, uint8_t emphasized)
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        egui_canvas_draw_round_rectangle_fill(&uicode_get_core()->canvas, line_region.location.x, line_region.location.y + i * (local->compact_mode ? 4 : 5), line_region.size.width,
