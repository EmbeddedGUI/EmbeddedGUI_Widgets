...
static const egui_view_virtualizing_wrap_panel_item_t compact_items_1[] = {
        {"Q", "Dense", "1", EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_TONE_NEUTRAL, 0, EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_WIDTH_BALANCED},
        {"R", "Window", "2", EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_TONE_ACCENT, 1, EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_WIDTH_PROMINENT},
        {"S", "Rows", "3", EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_TONE_SUCCESS, 0, EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_WIDTH_BALANCED},
        {"T", "Tokens", "4", EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_TONE_WARNING, 0, EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_WIDTH_PROMINENT},
        {"U", "Focus", "5", EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_TONE_ACCENT, 0, EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_WIDTH_BALANCED},
        {"V", "Track", "6", EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_TONE_SUCCESS, 0, EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_WIDTH_PROMINENT},
        {"W", "Thumb", "7", EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_TONE_WARNING, 1, EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_WIDTH_BALANCED},
        {"X", "Read", "8", EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_TONE_NEUTRAL, 0, EGUI_VIEW_VIRTUALIZING_WRAP_PANEL_WIDTH_PROMINENT},
};

static const egui_view_virtualizing_wrap_panel_snapshot_t compact_snapshots[] = {
        {"OPS", "Compact window", "", "", compact_items_0, 8, 0, 0},
        {"LAY", "Compact dense", "", "", compact_items_1, 8, 4, 2},
};
...
{
    egui_view_virtualizing_wrap_panel_set_current_snapshot(EGUI_VIEW_OF(&wrap_compact), index % COMPACT_SNAPSHOT_COUNT);
}
...
void test_init_ui(void)
{
    ...
    egui_view_virtualizing_wrap_panel_set_snapshots(EGUI_VIEW_OF(&wrap_compact), compact_snapshots, COMPACT_SNAPSHOT_COUNT);
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 2:
        if (first_call)
        {
            apply_primary_key(EGUI_KEY_CODE_RIGHT, 0);
        }
        EGUI_SIM_SET_WAIT(p_action, VIRTUALIZING_WRAP_PANEL_RECORD_WAIT);
        return true;
    case 3:
    ...
    case 4:
        if (first_call)
        {
            apply_primary_key(EGUI_KEY_CODE_DOWN, 0);
        }
        EGUI_SIM_SET_WAIT(p_action, VIRTUALIZING_WRAP_PANEL_RECORD_WAIT);
        return true;
    case 5:
