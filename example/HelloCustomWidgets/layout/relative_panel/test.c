...
{
    egui_view_relative_panel_set_current_snapshot(EGUI_VIEW_OF(&relative_panel_compact), 0);
    egui_view_relative_panel_set_current_snapshot(EGUI_VIEW_OF(&relative_panel_read_only), 0);
    if (ui_ready)
    {
        layout_page();
    }
...
void test_init_ui(void)
{
    ...
    egui_view_relative_panel_set_snapshots(EGUI_VIEW_OF(&relative_panel_compact), &compact_snapshot, 1);
