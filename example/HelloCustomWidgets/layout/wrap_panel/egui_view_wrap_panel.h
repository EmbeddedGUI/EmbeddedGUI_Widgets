#ifndef _EGUI_VIEW_WRAP_PANEL_H_
#define _EGUI_VIEW_WRAP_PANEL_H_
...
#define EGUI_VIEW_WRAP_PANEL_MAX_SNAPSHOTS 6
#define EGUI_VIEW_WRAP_PANEL_MAX_ITEMS     8
#define EGUI_VIEW_WRAP_PANEL_ITEM_NONE     0xFF

#define EGUI_VIEW_WRAP_PANEL_TONE_ACCENT  0
#define EGUI_VIEW_WRAP_PANEL_TONE_SUCCESS 1
#define EGUI_VIEW_WRAP_PANEL_TONE_WARNING 2
#define EGUI_VIEW_WRAP_PANEL_TONE_NEUTRAL 3

#define EGUI_VIEW_WRAP_PANEL_WIDTH_COMPACT   0
#define EGUI_VIEW_WRAP_PANEL_WIDTH_BALANCED  1
#define EGUI_VIEW_WRAP_PANEL_WIDTH_PROMINENT 2

typedef struct egui_view_wrap_panel_item egui_view_wrap_panel_item_t;
struct egui_view_wrap_panel_item
{
    const char *badge;
    const char *title;
    const char *meta;
...
typedef struct egui_view_wrap_panel_snapshot egui_view_wrap_panel_snapshot_t;
struct egui_view_wrap_panel_snapshot
{
    const char *header;
    const char *title;
    const char *summary;
    const char *footer;
    const egui_view_wrap_panel_item_t *items;
    uint8_t item_count;
    uint8_t selected_item;
};

typedef void (*egui_view_on_wrap_panel_action_listener_t)(egui_view_t *self, uint8_t snapshot_index, uint8_t item_index);

typedef struct egui_view_wrap_panel egui_view_wrap_panel_t;
struct egui_view_wrap_panel
{
    egui_view_t base;
    const egui_view_wrap_panel_snapshot_t *snapshots;
    const egui_font_t *font;
    const egui_font_t *meta_font;
    egui_view_on_wrap_panel_action_listener_t on_action;
...
#endif /* _EGUI_VIEW_WRAP_PANEL_H_ */
