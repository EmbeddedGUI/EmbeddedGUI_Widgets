...
static const egui_view_virtualizing_stack_panel_item_t compact_items_1[] = {
        {"Q", "Dense", "Windowed rows", "1", EGUI_VIEW_VIRTUALIZING_STACK_PANEL_TONE_NEUTRAL, 0},
        {"R", "Window", "Thumb rail", "2", EGUI_VIEW_VIRTUALIZING_STACK_PANEL_TONE_ACCENT, 1},
        {"S", "Rows", "Calm preview", "3", EGUI_VIEW_VIRTUALIZING_STACK_PANEL_TONE_SUCCESS, 0},
        {"T", "Tokens", "Read only", "4", EGUI_VIEW_VIRTUALIZING_STACK_PANEL_TONE_WARNING, 0},
        {"U", "Focus", "Static touch", "5", EGUI_VIEW_VIRTUALIZING_STACK_PANEL_TONE_ACCENT, 0},
        {"V", "Track", "Guard state", "6", EGUI_VIEW_VIRTUALIZING_STACK_PANEL_TONE_SUCCESS, 0},
        {"W", "Thumb", "Muted shell", "7", EGUI_VIEW_VIRTUALIZING_STACK_PANEL_TONE_WARNING, 1},
        {"X", "Read", "Dense lane", "8", EGUI_VIEW_VIRTUALIZING_STACK_PANEL_TONE_NEUTRAL, 0},
};

static const egui_view_virtualizing_stack_panel_snapshot_t compact_snapshots[] = {
...
{
    egui_view_virtualizing_stack_panel_set_current_snapshot(EGUI_VIEW_OF(&stack_compact), index % COMPACT_SNAPSHOT_COUNT);
}
...
void test_init_ui(void)
{
    ...
    egui_view_virtualizing_stack_panel_set_snapshots(EGUI_VIEW_OF(&stack_compact), compact_snapshots, COMPACT_SNAPSHOT_COUNT);
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 6:
        if (first_call)
        {
            apply_primary_key(EGUI_KEY_CODE_HOME, 0);
        }
        EGUI_SIM_SET_WAIT(p_action, VIRTUALIZING_STACK_PANEL_RECORD_WAIT);
        return true;
    case 7:
    ...
    case 8:
        if (first_call)
        {
            apply_primary_key(EGUI_KEY_CODE_END, 0);
        }
        EGUI_SIM_SET_WAIT(p_action, VIRTUALIZING_STACK_PANEL_RECORD_WAIT);
        return true;
    case 9:
    ...
    case 15:
        ...
        return true;
    case 16:
        set_click_view_center(p_action, EGUI_VIEW_OF(&stack_compact), 220);
        return true;
    case 17:
        if (first_call)
        {
