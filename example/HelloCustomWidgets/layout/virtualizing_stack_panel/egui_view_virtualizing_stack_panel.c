...
#define EGUI_VIEW_VIRTUALIZING_STACK_PANEL_STANDARD_SHELL_GAP    4
...
#define EGUI_VIEW_VIRTUALIZING_STACK_PANEL_STANDARD_SHELL_PAD_Y  4
#define EGUI_VIEW_VIRTUALIZING_STACK_PANEL_STANDARD_FOOTER_H     8
#define EGUI_VIEW_VIRTUALIZING_STACK_PANEL_STANDARD_FOOTER_GAP   3
