...
def source_template(name: str, display_title: str) -> str:
    return normalize_template(
        ...
        EGUI_BACKGROUND_COLOR_PARAM_INIT_ROUND_RECTANGLE({name}_bg_standard_param, HCW_COLOR_SURFACE, EGUI_ALPHA_100, 12);
        ...
        EGUI_BACKGROUND_COLOR_PARAM_INIT_ROUND_RECTANGLE({name}_bg_compact_param, HCW_COLOR_SURFACE_SUBTLE, EGUI_ALPHA_100, 10);
        ...
        EGUI_BACKGROUND_COLOR_PARAM_INIT_ROUND_RECTANGLE({name}_bg_read_only_param, HCW_COLOR_SURFACE_PRESS, EGUI_ALPHA_100, 10);
        ...
        {{
            egui_color_t badge_color = HCW_COLOR_PRIMARY;
            egui_color_t title_color = HCW_COLOR_TEXT;
            egui_color_t summary_color = HCW_COLOR_TEXT_MUTED;
            ...
            {{
                ...
                badge_color = HCW_COLOR_TEXT_SOFT;
                title_color = HCW_COLOR_TEXT_MUTED;
                summary_color = HCW_COLOR_TEXT_SOFT;
            }}
            else if (widget->compact_mode)
            {{
                background = EGUI_BG_OF(&{name}_bg_compact);
                badge_color = HCW_COLOR_PRIMARY;
                title_color = HCW_COLOR_TEXT;
                summary_color = HCW_COLOR_TEXT_MUTED;
            }}
