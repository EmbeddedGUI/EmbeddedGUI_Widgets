...
#endif
#define CALENDAR_DATE_PICKER_ROOT_WIDTH            224
#define CALENDAR_DATE_PICKER_ROOT_HEIGHT           264
#define CALENDAR_DATE_PICKER_PRIMARY_WIDTH         196
#define CALENDAR_DATE_PICKER_PRIMARY_OPEN_HEIGHT   180
#define CALENDAR_DATE_PICKER_PRIMARY_CLOSED_HEIGHT 82
#define CALENDAR_DATE_PICKER_PREVIEW_WIDTH         104
#define CALENDAR_DATE_PICKER_PREVIEW_HEIGHT        48
#define CALENDAR_DATE_PICKER_BOTTOM_ROW_WIDTH      216
#define CALENDAR_DATE_PICKER_BOTTOM_ROW_HEIGHT     48
...
typedef struct calendar_date_picker_snapshot calendar_date_picker_snapshot_t;
struct calendar_date_picker_snapshot
{
    uint16_t year;
    uint16_t panel_year;
    uint8_t month;
...
static egui_view_calendar_date_picker_t picker_primary;
static egui_view_linearlayout_t bottom_row;
static egui_view_calendar_date_picker_t picker_compact;
static egui_view_calendar_date_picker_t picker_read_only;
...
static const char *title_text = "Calendar Date Picker";

static const calendar_date_picker_snapshot_t primary_snapshots[] = {
        {2026, 2026, 3, 3, 18, 1},
        {2026, 2026, 3, 4, 18, 1},
        {2026, 2026, 4, 4, 2, 1},
};

static const calendar_date_picker_snapshot_t compact_snapshot = {2026, 2026, 3, 3, 18, 0};
static const calendar_date_picker_snapshot_t read_only_snapshot = {2026, 2026, 4, 4, 5, 0};
...
{
    uint8_t opened = egui_view_calendar_date_picker_get_opened(EGUI_VIEW_OF(&picker_primary));
    ...
    egui_view_set_size(EGUI_VIEW_OF(&picker_primary), CALENDAR_DATE_PICKER_PRIMARY_WIDTH, opened ? CALENDAR_DATE_PICKER_PRIMARY_OPEN_HEIGHT : CALENDAR_DATE_PICKER_PRIMARY_CLOSED_HEIGHT);
...
static void apply_snapshot_to_picker(egui_view_t *view, const calendar_date_picker_snapshot_t *snapshot)
{
    egui_view_calendar_date_picker_set_date(view, snapshot->year, snapshot->month, snapshot->day);
    egui_view_calendar_date_picker_set_display_month(view, snapshot->panel_year, snapshot->panel_month);
    egui_view_calendar_date_picker_set_opened(view, snapshot->opened);
}
...
{
    apply_primary_snapshot(CALENDAR_DATE_PICKER_DEFAULT_SNAPSHOT);
}
...
void test_init_ui(void)
{
    ...
    egui_view_set_size(EGUI_VIEW_OF(&root_layout), CALENDAR_DATE_PICKER_ROOT_WIDTH, CALENDAR_DATE_PICKER_ROOT_HEIGHT);
    ...
    egui_view_set_size(EGUI_VIEW_OF(&title_label), CALENDAR_DATE_PICKER_ROOT_WIDTH, 18);
    ...
    egui_view_calendar_date_picker_init(EGUI_VIEW_OF(&picker_primary));
    egui_view_set_size(EGUI_VIEW_OF(&picker_primary), CALENDAR_DATE_PICKER_PRIMARY_WIDTH, CALENDAR_DATE_PICKER_PRIMARY_OPEN_HEIGHT);
    egui_view_calendar_date_picker_set_font(EGUI_VIEW_OF(&picker_primary), (const egui_font_t *)&egui_res_font_montserrat_10_4);
    egui_view_calendar_date_picker_set_meta_font(EGUI_VIEW_OF(&picker_primary), (const egui_font_t *)&egui_res_font_montserrat_8_4);
    egui_view_calendar_date_picker_set_label(EGUI_VIEW_OF(&picker_primary), "Ship date");
    egui_view_calendar_date_picker_set_helper(EGUI_VIEW_OF(&picker_primary), "Tap day or use +/-");
    ...
    egui_view_set_size(EGUI_VIEW_OF(&bottom_row), CALENDAR_DATE_PICKER_BOTTOM_ROW_WIDTH, CALENDAR_DATE_PICKER_BOTTOM_ROW_HEIGHT);
    egui_view_linearlayout_set_orientation(EGUI_VIEW_OF(&bottom_row), 1);
    egui_view_linearlayout_set_align_type(EGUI_VIEW_OF(&bottom_row), EGUI_ALIGN_VCENTER);
    egui_view_group_add_child(EGUI_VIEW_OF(&root_layout), EGUI_VIEW_OF(&bottom_row));

    egui_view_calendar_date_picker_init(EGUI_VIEW_OF(&picker_compact));
    egui_view_set_size(EGUI_VIEW_OF(&picker_compact), CALENDAR_DATE_PICKER_PREVIEW_WIDTH, CALENDAR_DATE_PICKER_PREVIEW_HEIGHT);
    egui_view_calendar_date_picker_set_font(EGUI_VIEW_OF(&picker_compact), (const egui_font_t *)&egui_res_font_montserrat_10_4);
    egui_view_calendar_date_picker_set_meta_font(EGUI_VIEW_OF(&picker_compact), (const egui_font_t *)&egui_res_font_montserrat_8_4);
    ...
    egui_view_calendar_date_picker_init(EGUI_VIEW_OF(&picker_read_only));
    egui_view_set_size(EGUI_VIEW_OF(&picker_read_only), CALENDAR_DATE_PICKER_PREVIEW_WIDTH, CALENDAR_DATE_PICKER_PREVIEW_HEIGHT);
    egui_view_set_margin(EGUI_VIEW_OF(&picker_read_only), 8, 0, 0, 0);
    egui_view_calendar_date_picker_set_font(EGUI_VIEW_OF(&picker_read_only), (const egui_font_t *)&egui_res_font_montserrat_10_4);
    egui_view_calendar_date_picker_set_meta_font(EGUI_VIEW_OF(&picker_read_only), (const egui_font_t *)&egui_res_font_montserrat_8_4);
    egui_view_calendar_date_picker_set_today(EGUI_VIEW_OF(&picker_read_only), 2026, 3, 15);
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 6:
        ...
        EGUI_SIM_SET_WAIT(p_action, CALENDAR_DATE_PICKER_RECORD_FINAL_WAIT);
        return true;
    default:
        return false;
    }
