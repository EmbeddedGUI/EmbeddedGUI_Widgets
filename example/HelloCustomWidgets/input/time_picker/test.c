...
void test_init_ui(void)
{
    ...
    egui_view_time_picker_set_palette(EGUI_VIEW_OF(&picker_primary), HCW_COLOR_SURFACE, HCW_COLOR_BORDER_STRONG, HCW_COLOR_TEXT_STRONG,
    ...
    egui_view_time_picker_set_palette(EGUI_VIEW_OF(&picker_compact), HCW_COLOR_SURFACE, HCW_COLOR_BORDER_STRONG, HCW_COLOR_TEXT_STRONG,
                                      HCW_COLOR_TEXT_SOFT, HCW_COLOR_PRIMARY_DARK);
    ...
    egui_view_time_picker_set_palette(EGUI_VIEW_OF(&picker_read_only), HCW_COLOR_SURFACE, HCW_COLOR_TRACK_STRONG, HCW_COLOR_TEXT,
                                      HCW_COLOR_TEXT_SOFT, HCW_COLOR_PRIMARY_DARK);
