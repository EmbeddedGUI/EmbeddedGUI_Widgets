...
void test_init_ui(void)
{
    ...
    egui_view_button_init(EGUI_VIEW_OF(&primary_link_button), uicode_get_core());
    ...
    egui_view_button_init(EGUI_VIEW_OF(&inline_preview_button), uicode_get_core());
    ...
    egui_view_button_init(EGUI_VIEW_OF(&disabled_preview_button), uicode_get_core());
