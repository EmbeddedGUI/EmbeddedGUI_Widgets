...
{
    relocate_view(EGUI_VIEW_OF(&box_keyboard), 0, TEXT_BOX_KEYBOARD_Y);
}

static void position_keyboard_hidden(void)
{
    relocate_view(EGUI_VIEW_OF(&box_keyboard), 0, TEXT_BOX_KEYBOARD_HIDDEN_Y);
}
...
void test_init_ui(void)
{
    ...
    egui_view_textinput_init(EGUI_VIEW_OF(&box_primary), uicode_get_core());
    ...
    egui_view_textinput_init(EGUI_VIEW_OF(&box_compact), uicode_get_core());
    ...
    egui_view_textinput_init(EGUI_VIEW_OF(&box_read_only), uicode_get_core());
    ...
    egui_view_textinput_set_text_color(EGUI_VIEW_OF(&box_read_only), HCW_COLOR_TEXT_STRONG, EGUI_ALPHA_100);
...
bool egui_port_get_recording_action(int action_index, egui_sim_action_t *p_action)
{
    ...
    case 0:
        ...
        return true;
    case 1:
        if (!set_primary_field_click_action(p_action, TEXT_BOX_RECORD_WAIT))
        {
