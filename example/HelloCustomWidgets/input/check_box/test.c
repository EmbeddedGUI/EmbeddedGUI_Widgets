...
{
    box->box_color = HCW_COLOR_BORDER;
    box->box_fill_color = HCW_COLOR_PRIMARY;
    box->check_color = EGUI_COLOR_WHITE;
    box->text_color = HCW_COLOR_TEXT;
    box->text_gap = 6;
}

static void apply_disabled_preview_palette(egui_view_checkbox_t *box)
{
    box->box_color = HCW_COLOR_TRACK_STRONG;
    box->box_fill_color = HCW_COLOR_TRACK_STRONG;
    box->check_color = HCW_COLOR_SURFACE;
    box->text_color = HCW_COLOR_TEXT_STRONG;
    box->text_gap = 6;
}
...
void test_init_ui(void)
{
    ...
    egui_view_checkbox_init(EGUI_VIEW_OF(&control_primary), uicode_get_core());
