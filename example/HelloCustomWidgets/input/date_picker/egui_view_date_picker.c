...
#define EGUI_VIEW_DATE_PICKER_STANDARD_FILL_ALPHA         EGUI_ALPHA_MAKE(98)
#define EGUI_VIEW_DATE_PICKER_STANDARD_BORDER_ALPHA       EGUI_ALPHA_MAKE(96)
...
#define EGUI_VIEW_DATE_PICKER_STANDARD_FIELD_FILL_ALPHA   EGUI_ALPHA_MAKE(98)
#define EGUI_VIEW_DATE_PICKER_STANDARD_FIELD_BORDER_ALPHA EGUI_ALPHA_MAKE(98)
...
#define EGUI_VIEW_DATE_PICKER_STANDARD_PANEL_FILL_ALPHA   EGUI_ALPHA_MAKE(98)
#define EGUI_VIEW_DATE_PICKER_STANDARD_PANEL_BORDER_ALPHA EGUI_ALPHA_MAKE(98)
#define EGUI_VIEW_DATE_PICKER_STANDARD_HELPER_GAP         5
#define EGUI_VIEW_DATE_PICKER_STANDARD_HELPER_HEIGHT      10
#define EGUI_VIEW_DATE_PICKER_FIELD_TEXT_INSET_X          8
#define EGUI_VIEW_DATE_PICKER_FIELD_CHEVRON_WIDTH         18
#define EGUI_VIEW_DATE_PICKER_FIELD_CHEVRON_END_PAD       4
#define EGUI_VIEW_DATE_PICKER_FIELD_CHEVRON_TEXT_GAP      4
#define EGUI_VIEW_DATE_PICKER_FIELD_DIVIDER_GAP           4
#define EGUI_VIEW_DATE_PICKER_FIELD_DIVIDER_TOP_INSET     6
#define EGUI_VIEW_DATE_PICKER_FIELD_DIVIDER_BOTTOM_INSET  7
#define EGUI_VIEW_DATE_PICKER_PANEL_INSET_X               6
#define EGUI_VIEW_DATE_PICKER_PANEL_NAV_INSET_X           5
#define EGUI_VIEW_DATE_PICKER_PANEL_HEADER_TOP_INSET      4
#define EGUI_VIEW_DATE_PICKER_PANEL_NAV_BUTTON_WIDTH      20
#define EGUI_VIEW_DATE_PICKER_PANEL_NAV_BUTTON_HEIGHT     16
#define EGUI_VIEW_DATE_PICKER_PANEL_NAV_GAP               5
#define EGUI_VIEW_DATE_PICKER_PANEL_GRID_GAP              2

#define EGUI_VIEW_DATE_PICKER_COMPACT_RADIUS             8
#define EGUI_VIEW_DATE_PICKER_COMPACT_FILL_ALPHA         EGUI_ALPHA_MAKE(96)
#define EGUI_VIEW_DATE_PICKER_COMPACT_BORDER_ALPHA       EGUI_ALPHA_MAKE(94)
...
#define EGUI_VIEW_DATE_PICKER_COMPACT_FIELD_FILL_ALPHA   EGUI_ALPHA_MAKE(96)
#define EGUI_VIEW_DATE_PICKER_COMPACT_FIELD_BORDER_ALPHA EGUI_ALPHA_MAKE(94)
...
static void date_picker_get_metrics(egui_view_date_picker_t *local, egui_view_t *self, egui_view_date_picker_metrics_t *metrics)
{
    ...
    metrics->field_text_region.location.x = metrics->field_region.location.x + EGUI_VIEW_DATE_PICKER_FIELD_TEXT_INSET_X;
    ...
    metrics->chevron_region.size.width = local->read_only_mode ? 0 : EGUI_VIEW_DATE_PICKER_FIELD_CHEVRON_WIDTH;
    ...
    metrics->panel_title_region.location.y = metrics->panel_region.location.y + EGUI_VIEW_DATE_PICKER_PANEL_HEADER_TOP_INSET;
    metrics->panel_title_region.size.height = panel_title_h;

    metrics->panel_prev_region.size.width = EGUI_VIEW_DATE_PICKER_PANEL_NAV_BUTTON_WIDTH;
    metrics->panel_prev_region.size.height = EGUI_VIEW_DATE_PICKER_PANEL_NAV_BUTTON_HEIGHT;
    metrics->panel_next_region.size.width = EGUI_VIEW_DATE_PICKER_PANEL_NAV_BUTTON_WIDTH;
    metrics->panel_next_region.size.height = EGUI_VIEW_DATE_PICKER_PANEL_NAV_BUTTON_HEIGHT;
    metrics->panel_prev_region.location.x = metrics->panel_region.location.x + EGUI_VIEW_DATE_PICKER_PANEL_NAV_INSET_X;
    metrics->panel_next_region.location.x = metrics->panel_region.location.x + metrics->panel_region.size.width -
                                            EGUI_VIEW_DATE_PICKER_PANEL_NAV_INSET_X -
    ...
    metrics->panel_title_region.location.x =
            metrics->panel_prev_region.location.x + metrics->panel_prev_region.size.width + EGUI_VIEW_DATE_PICKER_PANEL_NAV_GAP;
    panel_title_right = metrics->panel_next_region.location.x - EGUI_VIEW_DATE_PICKER_PANEL_NAV_GAP;
    ...
    metrics->panel_week_region.location.x = metrics->panel_region.location.x + EGUI_VIEW_DATE_PICKER_PANEL_INSET_X;
    metrics->panel_week_region.location.y =
            metrics->panel_title_region.location.y + metrics->panel_title_region.size.height + EGUI_VIEW_DATE_PICKER_PANEL_HEADER_TOP_INSET;
    metrics->panel_week_region.size.width = metrics->panel_region.size.width - EGUI_VIEW_DATE_PICKER_PANEL_INSET_X * 2;
    ...
    metrics->panel_grid_region.location.x = metrics->panel_region.location.x + EGUI_VIEW_DATE_PICKER_PANEL_INSET_X;
    metrics->panel_grid_region.location.y =
            metrics->panel_week_region.location.y + metrics->panel_week_region.size.height + EGUI_VIEW_DATE_PICKER_PANEL_GRID_GAP;
    metrics->panel_grid_region.size.width = metrics->panel_week_region.size.width;
    panel_grid_bottom = metrics->panel_region.location.y + metrics->panel_region.size.height - EGUI_VIEW_DATE_PICKER_PANEL_INSET_X;
                                   ...
                                   egui_color_t text_color, egui_color_t muted_text_color, egui_color_t border_color)
{
    ...
    {
        egui_dim_t divider_x = metrics->chevron_region.location.x - EGUI_VIEW_DATE_PICKER_FIELD_DIVIDER_GAP;
        ...
        egui_canvas_draw_line(&uicode_get_core()->canvas, divider_x,
                              metrics->field_region.location.y + EGUI_VIEW_DATE_PICKER_FIELD_DIVIDER_TOP_INSET, divider_x,
                              metrics->field_region.location.y + metrics->field_region.size.height -
                                      EGUI_VIEW_DATE_PICKER_FIELD_DIVIDER_BOTTOM_INSET,
                              1, divider_color, egui_color_alpha_mix(self->alpha, EGUI_ALPHA_MAKE(local->open_mode ? 88 : 78)));
        date_picker_draw_chevron(self, &metrics->chevron_region, egui_rgb_mix(muted_text_color, accent_color, EGUI_ALPHA_MAKE(34)),
                                 local->open_mode ? 3 : 2);
    }
}
                                   ...
                                   egui_color_t text_color, egui_color_t muted_text_color, egui_color_t border_color)
{
    ...
    date_picker_draw_chevron(self, &metrics->panel_prev_region, egui_rgb_mix(muted_text_color, accent_color, EGUI_ALPHA_MAKE(32)), 0);
    date_picker_draw_chevron(self, &metrics->panel_next_region, egui_rgb_mix(muted_text_color, accent_color, EGUI_ALPHA_MAKE(32)), 1);
