...
#define SEARCH_BOX_KEYBOARD_Y        ((EGUI_CONFIG_SCREEN_HEIGHT > SEARCH_BOX_KEYBOARD_HEIGHT) ? (EGUI_CONFIG_SCREEN_HEIGHT - SEARCH_BOX_KEYBOARD_HEIGHT) : 0)
#define SEARCH_BOX_KEYBOARD_HIDDEN_Y (EGUI_CONFIG_SCREEN_HEIGHT + SEARCH_BOX_KEYBOARD_HEIGHT)
...
void test_init_ui(void)
{
    ...
    egui_view_set_size(EGUI_VIEW_OF(&box_keyboard), EGUI_CONFIG_SCREEN_WIDTH, SEARCH_BOX_KEYBOARD_HEIGHT);
    position_keyboard_hidden();
