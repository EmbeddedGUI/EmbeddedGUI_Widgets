...
void test_init_ui(void)
{
    ...
    egui_view_combobox_init(EGUI_VIEW_OF(&control_primary), uicode_get_core());
    ...
    egui_view_combobox_init(EGUI_VIEW_OF(&control_compact), uicode_get_core());
    ...
    egui_view_combobox_init(EGUI_VIEW_OF(&control_read_only), uicode_get_core());
